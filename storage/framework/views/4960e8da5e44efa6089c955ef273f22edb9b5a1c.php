        ...
        <div class="row justify-content-between">
            <div class="col-md-10">
                ...
                <div class="col-sm-4 form-group mb-3 pl-0">
                    ...
                    <input type="text" name="order_number" value="<?php echo e(old('order_number')); ?>"  class="form-control <?php $__errorArgs = ['order_number'];
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-sm-4 form-group mb-3 pl-0">
                    ...
                    <input type="text" name="invoice_code" value="<?php echo e(old('invoice_code')); ?>" class="form-control <?php $__errorArgs = ['invoice_code'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border border-danger <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="tenant_id">
                        ...
                        <?php $__currentLoopData = \App\Tenant::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tenant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($tenant->id); ?>"<?php echo e(old('tenant_id')== $tenant->id ?  "selected" : ""); ?>><?php echo e($tenant->name); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
            ...
            <div class="col-md-12 table-responsive">
                <table class="table table-hover mb-3">
                    ...
                    <tr>
                        <th scope="row">1</th>
                        <td>
                            <input name="service_name" type="text" class="form-control" value="<?php echo e(old('service_name')); ?>"
                                   placeholder="<?php echo e(__('accounting::_.service_', ['something' => 'اسم'])); ?>" id="serviceName">
                        </td>
                        <td>
                            <input name="service_price" type="number" class="form-control" value="<?php echo e(old('service_price')); ?>"
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('amount') ? old('amount') : 0); ?>"></td>
                        </tr>
...
<?php /**PATH C:\xampp\htdocs\waqf\Modules/Accounting\Resources/views/invoices/partials/_edit.blade.php ENDPATH**/ ?>