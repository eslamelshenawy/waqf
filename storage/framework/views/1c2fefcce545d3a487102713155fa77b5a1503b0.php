                        ...
                        <?php if($buildings->get() && $buildings->count()): ?>
                            <?php $__currentLoopData = $buildings->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $building): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td scope="row"><?php echo e($building->district); ?>,<?php echo e($building->street); ?></td>
                                    <td scope="row"><?php echo e($tenant->where('id',$building->estaterent->tenant_id)->first()->name); ?></td>
                                    <td scope="row"><?php echo e($estateOrder->where('tenant_id',$building->estaterent->tenant_id)->first()->rented_at); ?></td>
                                </tr>
...
<?php /**PATH C:\xampp\htdocs\waqf\Modules/Client\Resources/views/users/resultInformation.blade.php ENDPATH**/ ?>