...
<?php $__env->startSection('content'); ?>
    <section class="roles-and-permissions">
        ...
        <?php if($check_advance->isEmpty() && $check_advance2->isEmpty()&& $check_advance1->isNotEmpty() && $check_advance3->isNotEmpty() || \App\Advance::get()->isEmpty()): ?>
       ...
       <div class="modal-body">
           ...
           <div class="form-row">
               <div class="col-md-6 mb-2">
                   ...
                   <input type="number" name="number_advance" value="" id="number_advance" class="form-control ">
               </div>
               <div class="col-md-6 mb-2">
...
<?php echo $__env->make('client::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\waqf\Modules/Client\Resources/views/users/advance.blade.php ENDPATH**/ ?>