                ...
                <div class="col-md-12">
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <div class="card-title"><br><h4><?php echo e(__('shared::estates.building', ['something' => __('shared::actions.edit')])); ?></h4><br></div>
                            <hr>
                            <form class="needs-validation" novalidate method="POST"
                                  action="<?php echo e(route('Admin::buildings.update', $building->id)); ?>"
...
unset($__errorArgs, $__bag); ?>" name="name"
                                               id="name" value="<?php echo e(old('name', $building->name)); ?>"
                                    ...
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <select class="form-control" name="city">
                                            ...
                                            <?php $__currentLoopData = $city->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($c->name_en); ?>" <?php echo e(old('city') == $c->name_en || $building->city_id == $c->id ? 'selected' : ''); ?>><?php echo e($c->name_ar); ?></option>
...
unset($__errorArgs, $__bag); ?>"
                                               name="district"
                                               id="district" value="<?php echo e(old('district', $building->district)); ?>" placeholder="<?php echo e(__('shared::estates.district')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" name="street"
                                               id="street" value="<?php echo e(old('street', $building->street)); ?>" placeholder="<?php echo e(__('shared::estates.street')); ?>" required>
...
unset($__errorArgs, $__bag); ?>"
                                               name="number"
                                               id="number" value="<?php echo e(old('number', $building->number)); ?>" placeholder="<?php echo e(__('shared::commons.number')); ?>"maxlength="10" required>
...
unset($__errorArgs, $__bag); ?>" name="space"
                                               id="space" value="<?php echo e(old('space', $building->space)); ?>"maxlength="10"
                                               placeholder="<?php echo e(__('shared::commons.space')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" name="price" maxlength="9"
                                               id="price" value="<?php echo e(old('price', $building->price)); ?>" placeholder="<?php echo e(__('shared::commons.price')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" name="number_of_apartments"
                                                           id="numberOfApartments" value="<?php echo e(old('number_of_apartments', $building->number_of_apartments)); ?>" placeholder="0" required></td>
...
unset($__errorArgs, $__bag); ?>" name="number_of_floors"
                                                           id="numberOfFloors" value="<?php echo e(old('number_of_floors', $building->number_of_floors)); ?>" placeholder="0" required></td>
...
unset($__errorArgs, $__bag); ?>" name="number_of_shops" id="numberOfShops"
                                                           value="<?php echo e(old('number_of_shops', $building->number_of_shops)); ?>" placeholder="0" required></td>
                                            </tr>
                                        </table>
                                    </div>
                                </div>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-4 mb-1">
                                        ...
                                        <input type="text"
                                               ...
                                               id="instrumentNumber" value="<?php echo e(old('instrument_number', $building->instrument_number)); ?>"
                                               placeholder="<?php echo e(__('shared::estates.instrument_number')); ?>"maxlength="10" required>
...
unset($__errorArgs, $__bag); ?>" name="instrument_date_at"
                                               id="instrumentDataAt" value="<?php echo e(old('instrument_date_at', $building->instrument_date_at)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" name="court"
                                               id="courtName" value="<?php echo e(old('court', $building->court)); ?>" placeholder="<?php echo e(__('shared::estates.court')); ?>" required>
...
unset($__errorArgs, $__bag); ?>"
                                               ...
                                               id="constructionLicenseNumber" value="<?php echo e(old('construction_license_number', $building->construction_license_number)); ?>"
                                               placeholder="<?php echo e(__('shared::estates.construction_license_number')); ?>" maxlength="10" required>
...
unset($__errorArgs, $__bag); ?>"
                                               ...
                                               id="constructionLicenseDateAt" value="<?php echo e(old('construction_license_date_at', $building->construction_license_date_at)); ?>"
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="checkbox" id="buildingTypeResidential"
                                                   name="usage_type[]" value="residential" <?php echo e(old('usage_type.0') == 'residential' || in_array('residential', $building->usage_type) ? 'checked' : ''); ?>>
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="checkbox" id="buildingTypeCommerical"
                                                   name="usage_type[]" value="commercial" <?php echo e(old('usage_type.1', $building->usage_type) == 'commercial' || in_array('commercial', $building->usage_type) ? 'checked' : ''); ?>>
                                            <label class="form-check-label" for="buildingTypeCommercial"><?php echo e(__('shared::estates.commercial')); ?></label>
                                        </div>
                                    </div>
                                    <?php $__errorArgs = ['building_type'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-row">
                                    <div class="col-md-12">
                                        <label><?php echo e(__('shared::estates.instrument_image')); ?></label>
                                        &nbsp;&nbsp;<span>
                                            <a href="<?php echo e(url('/images')); ?>/<?php echo e(@$building->instrument_image); ?>">
                                                <?php echo e(__('shared::commons.current_image')); ?>

                                            </a>
                                        </span>
                                        <?php echo $__env->make('shared::includes._uploader_', ['field' => 'instrument_image', 'title' => __('shared::estates.instrument_image')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-row">
                                    <div class="col-md-12">
                                        ...
                                        &nbsp;&nbsp;<span>
                                            <a href="<?php echo e(url('/images')); ?>/<?php echo e(@$building->license_image); ?>">
                                                <?php echo e(__('shared::commons.current_image')); ?>
...
unset($__errorArgs, $__bag); ?>"
                                                  rows="8"
                                                  id="extraDetails"><?php echo e(old('extra_details', $building->extra_details)); ?></textarea>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-2 mb-2">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio"
                                                   ...
                                                   value="monthly" <?php if(old('rent_type') == 'monthly' || $building->rent_type == 'monthly'): ?> checked <?php endif; ?>>
                                    ...
                                    <div class="col-md-2 mb-2">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="rent_type"
                                                   ...
                                                   value="quarterly" <?php if(old('rent_type') == 'quarterly' || $building->rent_type == 'quarterly'): ?> checked <?php endif; ?>>
                                    ...
                                    <div class="col-md-2 mb-2">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="rent_type"
                                                   id="rentTypeMidterm"
                                                   value="midterm" <?php if(old('rent_type') == 'midterm' || $building->rent_type == 'midterm'): ?> checked <?php endif; ?>>
                                    ...
                                    <div class="col-md-2 mb-2">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio"
                                                   name="rent_type"
                                                   id="rentTypeYearly" value="yearly" <?php if(old('rent_type') == 'yearly' || $building->rent_type == 'yearly'): ?> checked <?php endif; ?>>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-row">
                                    <div class="col-md-12">
                                        <label><?php echo e(__('shared::estates.current_building_images')); ?></label>
                                    </div>
                                    <div class="col-md-12 mb-4">
                                        <?php $__currentLoopData = $building->images()->where(['more' => 'building-image', 'more' => null])->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox"
                                                   ...
                                                   value="1" <?php echo e($building->is_active ? 'checked' : ''); ?>>
...
<?php echo $__env->make('admin::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/forsama1/public_html/waqf/Modules/Admin/Resources/views/estates/buildings/edit.blade.php ENDPATH**/ ?>