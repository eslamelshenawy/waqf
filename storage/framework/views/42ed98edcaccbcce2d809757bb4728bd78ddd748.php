...
<?php $__env->startSection('content'); ?>
    ...
    <section class="blog-heading">
        <div class="container">
            <div class="blog-heading__body">
                <h1><?php echo e($page->where('slug', 'privacy')->first()->title); ?></h1>
    ...
    <section class="main-about-us">
        <div class="container">
            <?php echo $page->where('slug', 'privacy')->first()->content; ?>

        </div>
    </section>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('client::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/forsama1/public_html/waqf/Modules/StaticPage/Resources/views/privacy_policy.blade.php ENDPATH**/ ?>