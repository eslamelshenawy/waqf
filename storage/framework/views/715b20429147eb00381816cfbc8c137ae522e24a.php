...
<option value="سند داخلى" <?php echo e(old('voucher_type') == "سند داخلى" ? "selected" : ""); ?>>سند قبض داخلى</option>
<option value="سند خارجى" <?php echo e(old('voucher_type') == "سند خارجى" ? "selected" : ""); ?>>سند قبض خارجى</option>
...
<?php echo $__env->make('accounting::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/forsama1/public_html/waqf/Modules/Accounting/Resources/views/vouchers/receipts/create.blade.php ENDPATH**/ ?>