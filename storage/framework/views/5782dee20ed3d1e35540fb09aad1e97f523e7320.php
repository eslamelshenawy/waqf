<?php $__env->startSection('content'); ?>
 ...
 <?php echo $page->where('slug', 'login')->first()->content; ?>

                </p>
                <form method="POST" action="<?php echo e(route('beforeLogin')); ?>" class="singinform-form">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('client::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/forsama1/public_html/waqf/Modules/Client/Resources/views/auth/before_login.blade.php ENDPATH**/ ?>