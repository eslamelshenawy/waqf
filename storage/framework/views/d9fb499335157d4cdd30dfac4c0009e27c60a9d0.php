...
<section class="register register--bg_prim">
  <div class="container">
    <div class="heading">
      ...
      <p>
         <?php echo $page->where('slug', 'register')->first()->content; ?>
...
<?php echo $__env->make('client::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/forsama1/public_html/waqf/Modules/Client/Resources/views/register.blade.php ENDPATH**/ ?>