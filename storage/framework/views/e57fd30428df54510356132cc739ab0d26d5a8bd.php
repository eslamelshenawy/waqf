                                            ...
                                            <td scope="row">
                                                <?php if(auth()->user()->hasRole('super-admin') ||auth()->user()->can('read reports')): ?>
                                                    <!-- Button trigger modal -->
                                                        ...
                                                        <a data-toggle="modal" data-target="#exampleModal"  data_id="<?php echo e($box->id); ?>" class="text-success mr-2 details_voucher">
...
<?php echo $__env->make('accounting::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/forsama1/public_html/waqf/Modules/Accounting/Resources/views/reports/index.blade.php ENDPATH**/ ?>