        ...
        <div class="container">
            ...
            <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active myTabContent__-__new" id="home" role="tabpanel"
                    ...
                    <?php if($ordersTentans->count()): ?>
                        <?php $__currentLoopData = $ordersTentans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="search_info">
                                            <div class="search_info__details">
                                                <ul>
                                                    ...
                                                    <li>
اسم المستأجر : <?php echo e(@$order->tenanter->name); ?>

                                                    </li>
                                            <li>السعر: <?php echo e(@$order->amount); ?></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-sm-4 col-xs-12">
                                        <div class="search_info">
                                            <div class="search_info__details">
                                                <ul>
                                        <li>رقم التليفون : <?php echo e(@$order->tenanter->mobile); ?></li>
                                        <li>البريد: <?php echo e(@$order->tenanter->email); ?></li>
                                                    ...
                                                    <li>الشارع: <?php echo e(@$order->madeBy->street); ?></li>
                                                    <?php else: ?>
                                                     <li>الشارع: <?php echo e(@$order->madeBy->district); ?></li>
                                                    <?php endif; ?>
                                                </ul>
                                            </div>
                                        </div>
                                        ...
                                        <div class="search_info">
                                            <div class="search_info__details">
                                                ...
                                                <ul>
                                                    ...
                                                    <li>تاريخ الحجز:  <span><?php echo e(@$stringDate); ?></span></li>
...
<?php echo $__env->make('client::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/forsama1/public_html/waqf/Modules/Client/Resources/views/users/tenants/orders/index.blade.php ENDPATH**/ ?>