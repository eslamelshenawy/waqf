...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-6 mb-2" id="checke_num" style="display: none;">
                                        ...
                                        <input type="text" name="checke_num_in" class="form-control <?php $__errorArgs = ['checke_num_in'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border border-danger <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <select class=" form-control <?php $__errorArgs = ['account_idAttributable_out'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border border-danger <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-6 mb-2" id="checke_num_out" style="display: none;">
                                        ...
                                        <input type="text" name="checke_num_out" class="form-control <?php $__errorArgs = ['checke_num_out'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border border-danger <?php unset($message);
...
<?php echo $__env->make('accounting::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/forsama1/public_html/waqf/Modules/Accounting/Resources/views/vouchers/payments/edit.blade.php ENDPATH**/ ?>