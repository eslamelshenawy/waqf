...
<?php endif; ?>
            <div class="row">
                <div class="col-md-12">
                    <div class="card mb-4">
                        <div class="card-body">
                            <h4 class="card-title mb-3"><?php echo e(__('shared::actions.manage') . ' ' . __('shared::estates.shops')); ?></h4>
                            ...
                            <div class="table-responsive">
                                <table id="multicolumn_ordering_table" class="table table-striped table-bordered" style="width:100%">
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col"><?php echo e(__('shared::estates.the_building')); ?></th>
                                        <th scope="col"><i class="i-Check text"></i> </th>
                                        <th scope="col"></th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <?php if($shops && $shops->count()): ?>
                                        <?php $__currentLoopData = $shops; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $shop): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td scope="row"><?php echo e($shop->number); ?></td>
                                                <td scope="row"><?php echo e($shop->building->name); ?></td>
                                                <td scope="row">
                                                    <?php if(auth()->user()->hasRole('super-admin') ||auth()->user()->can('update shops')): ?>
                                                    <a href="<?php echo e(route('Admin::shops.edit', $shop->id)); ?>" class="text-success mr-2">
                                                        <i class="nav-icon i-Pen-2 font-weight-bold"></i>
                                                    </a>
                                                    <?php endif; ?>
                                                        <?php if(auth()->user()->hasRole('super-admin') ||auth()->user()->can('delete shops')): ?>

                                                        <form style="display: none;" method="POST" action="<?php echo e(route('Admin::shops.destroy', $shop->id)); ?>" id="form-<?php echo e($shop->id); ?>">
                                                        <?php echo csrf_field(); ?>
                                                        <?php echo method_field('DELETE'); ?>
                                                    </form>
                                                    <a href="JavaScript:void(0);" class="text-danger mr-2"
                                                       onclick="deleteEstate(<?php echo $shop->id; ?>)">
                                ...
                                <?php if(auth()->user()->hasRole('super-admin') ||auth()->user()->can('update shops')): ?>
                                <a type="submit" class="btn btn-raised btn-raised-primary btn-lg btn-rounded m-1 mt-3 btn-sm" href="<?php echo e(route('Admin::shops.create')); ?>">&plus; <?php echo e(__('shared::actions.new')); ?></a>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('admin::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/forsama1/public_html/waqf/Modules/Admin/Resources/views/estates/shops/index.blade.php ENDPATH**/ ?>