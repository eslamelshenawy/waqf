                                ...
                                <div class="row justify-content-between">
                                    <div class="col-md-10">
                                        ...
                                        <div class="col-sm-4 form-group mb-3 pl-0">
                                            ...
                                            <input type="text" name="order_number"  value="<?php echo e($invoice->order_number); ?>" class="form-control <?php $__errorArgs = ['order_number'];
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="col-sm-4 form-group mb-3 pl-0">
                                            ...
                                            <input type="text" name="invoice_code"  value="<?php echo e($invoice->invoice_code); ?>" class="form-control <?php $__errorArgs = ['invoice_code'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border border-danger <?php unset($message);
                                    ...
                                    <div class="col-md-12 table-responsive">
                                        <table class="table table-hover mb-3">
                                            ...
                                            <tr>
                                                <th scope="row">1</th>
                                                <td>
                                                    <input name="service_name" type="text" value="<?php echo e($invoiceDetails->service_name); ?>" class="form-control"
                                                           placeholder="<?php echo e(__('accounting::_.service_', ['something' => 'اسم'])); ?>" id="serviceName">
                                                </td>
                                                <td>
                                                    <input name="service_price" type="number" class="form-control" value="<?php echo e($invoiceDetails->service_price); ?>"
...
<?php echo $__env->make('accounting::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\waqf\Modules/Accounting\Resources/views/invoices/edit.blade.php ENDPATH**/ ?>