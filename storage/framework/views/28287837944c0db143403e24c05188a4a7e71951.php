                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="card-title"><br>
                                <h4> <?php echo e(__('shared::actions.edit') . ' ' . __('shared::users.beneficiary')); ?></h4>
                                <br>
                            </div>
                            <hr>

                            <form class="needs-validation" novalidate method="POST" action="<?php echo e(route("Admin::beneficiaries.update", $beneficiary->id)); ?>" autocomplete="off">
                                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                               name="name" value="<?php echo e(old('name', $beneficiary->name)); ?>" id="name" placeholder="<?php echo e(__('shared::commons.name')); ?>">
...
unset($__errorArgs, $__bag); ?>"
                                               name="email" id="email" value="<?php echo e(old('email', $beneficiary->email)); ?>"
...
unset($__errorArgs, $__bag); ?>"
                                               name="mobile" id="mobile" value="<?php echo e(old('mobile', $beneficiary->mobile)); ?>"
...
unset($__errorArgs, $__bag); ?>"
                                               name="identity_number" value="<?php echo e(old('identity_number', $beneficiary->mobile)); ?>"
                                    ...
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <select class="form-control" name="city">
                                            <?php $__currentLoopData = $city->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($c->name_en); ?>" <?php echo e($c->id == $beneficiary->city_id ? 'selected' : ''); ?>><?php echo e($c->name_ar); ?></option>
...
unset($__errorArgs, $__bag); ?>"
                                               name="birth_of_date_at" value="<?php echo e(old('birth_of_date_at', $beneficiary->birth_of_date_at)); ?>"
...
unset($__errorArgs, $__bag); ?>"
                                               name="release_at" value="<?php echo e(old('release_at', $beneficiary->release_at)); ?>"
...
unset($__errorArgs, $__bag); ?>"
                                               name="end_at" value="<?php echo e(old('end_at', $beneficiary->end_at)); ?>" autocomplete="off" id="endAt"
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <?php echo $__env->make('admin::lists._jobs', ['job' => $beneficiary->job], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                        <?php $__errorArgs = ['job'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-3 mb-3" id="jobTitleOtherDiv" style="display: <?php echo e($beneficiary->job_title_other != null ? 'block' : 'none'); ?>;">
                                        <label for="jobTitle"><?php echo e(__('shared::commons.job_title_other')); ?></label>
                                        <input type="text" value="<?php echo e(old('job_title_other', $beneficiary->job_title_other)); ?>"
                                ...
                                <div class="form-row">
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <input type="text" name="company_name"
                                               value="<?php echo e(old('company_name', $beneficiary->company_name)); ?>"
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <?php echo $__env->make('admin::lists._banks', ['bank_id' => $beneficiary->bank_id], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" name="bank_account_number" class="field form-control <?php $__errorArgs = ['bank_account_number'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border border-danger <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e($beneficiary->bank_account_number); ?>" id="bankAccountNumber"
                                               placeholder="<?php echo e(__('shared::commons.bank_account_number')); ?>"maxlength="14" autocomplete="off" required>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text"
                                               name="bank_iban_number" class="field form-control <?php $__errorArgs = ['bank_iban_number'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border border-danger <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                               id="ibanNumber" value="<?php echo e($beneficiary->bank_iban_number); ?>"
                                               placeholder="<?php echo e(__('shared::commons.bank_iban_number')); ?>"maxlength="25" autocomplete="off" required>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-4 mb-4">
                                        <label for="account_status"><?php echo e(__('shared::commons.account_status')); ?></label>

                                        <select class="field form-control" name="account_status" id="account_status">
                                            <option value="pending" <?php echo e($beneficiary->status == 'pending' ? 'selected' : ''); ?>><?php echo e(__('shared::commons.pending')); ?></option>
                                            <option value="confirmed" <?php echo e($beneficiary->status == 'confirmed' ? 'selected' : ''); ?>><?php echo e(__('shared::commons.confirmed')); ?></option>
                                            <option value="suspended" <?php echo e($beneficiary->status == 'suspended' ? 'selected' : ''); ?>><?php echo e(__('shared::commons.suspended')); ?></option>
                                        </select>
                                    ...
                                    <input type="hidden" id="maritalStatusValue"  value ="<?php echo e($beneficiary->marital_status); ?>"/>
                                <div class="form-row">
                                    ...
                                    <div class="col-md-4 mb-4">
                                        ...
                                        <select class="field form-control" name="marital_status" id="maritalStatus">
                                            <option value="single"  <?php echo e($beneficiary->marital_status == 'single' ? 'selected' : ''); ?>><?php echo e(__('shared::commons.single')); ?></option>
                                            <option value="married" <?php echo e($beneficiary->marital_status == 'married' ? 'selected' : ''); ?>><?php echo e(__('shared::commons.married')); ?></option>
                                            <option value="widower" <?php echo e($beneficiary->marital_status == 'widower' ? 'selected' : ''); ?>><?php echo e(__('shared::commons.widower')); ?></option>
                                            <option value="divorcee" <?php echo e($beneficiary->marital_status == 'divorcee' ? 'selected' : ''); ?>><?php echo e(__('shared::commons.divorcee')); ?></option>
                                        </select>

                                    </div>
                                </div>

                                <div class="form-row mt-2" id="haveKids" style="display: <?php echo e($beneficiary->is_has_kids ? 'block' : 'none'); ?>;">
                                    <div class="col-md-6 mb-3">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="custom-control custom-radio">
                                                <input type="radio" value="1" onclick="handleKids(this.value)"
                                                       class="custom-control-input is-has-kids" <?php echo e($beneficiary->is_has_kids == true ? 'checked' : ''); ?>
                                        ...
                                        <div class="cpl-md-6">
                                            <div class="custom-control custom-radio mb-3">
                                                <input type="radio" value="0" onclick="handleKids(this.value)" <?php echo e($beneficiary->is_has_kids == false ? 'checked' : ''); ?>
                                ...
                                <?php if(count($beneficiary->kids) != 0 || count($beneficiary->kids) == 0 ): ?>
                                    <div id="kids" style="display:<?php echo e(count($beneficiary->kids) || old('is_has_kids') == true ? 'block' : 'none'); ?>;">
                                        <!-- #StartKidSection -->
                                        <?php for($i=0; $i<count($beneficiary->kids); $i++): ?>
                                                ...
                                                <div class="form-row">
                                                    <div class="col-md-12 mb-3">
                                                        ...
                                                        <button class="btn btn-danger btn-raised-primary btn-sm btn-rounded m-1 mt-3 float-right"
                                                                id="removeBtn-<?php echo e($i); ?>" type="button" onclick="deleteKid(<?php echo $i; ?>)">&times;</button>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-row">
                                                    <div class="col-md-6 mb-3">
                                                        ...
                                                        <input type="text" class="form-control" name="kid_name[]" autocomplete="off" id="kidName"
                                                               placeholder="<?php echo e(__('shared::commons.kid_name')); ?>"
                                                               value="<?php echo e(old('kid_name.' . $i, $beneficiary->kids[$i]->name)); ?>" required>
                                                    </div>

                                                    <div class="col-md-6 mb-3">
                                                        <label for="kidIdentityNumber"><?php echo e(__('shared::commons.identity_number')); ?></label>
                                                        <input type="text" class="form-control"
                                                               name="kid_identity_number[]" value="<?php echo e(old('kid_identity_number.' . $i, $beneficiary->kids[$i]->identity_number)); ?>" autocomplete="off"
                                                               id="kidIdentityNumber"
                                                               placeholder="<?php echo e(__('shared::commons.kid_identity_number')); ?>" maxlength="10" required>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-row">
                                                    <div class="col-md-6 mb-3">
                                                        ...
                                                        <select name="kid_gender[]" class="form-control" id="kidGender">
                                                            <option value="male" <?php echo e($beneficiary->kids[$i]->gender == 'male' ? 'selected' : ''); ?>><?php echo e(__('shared::commons.male')); ?></option>
                                                            <option value="female" <?php echo e($beneficiary->kids[$i]->gender == 'female' ? 'selected' : ''); ?>><?php echo e(__('shared::commons.female')); ?></option>
                                                        </select>
                                                    ...
                                                    <div class="col-md-6 mb-3">
                                                        ...
                                                        <input type="date" class="form-control"
                                                               value="<?php echo e(old('kid_birth_of_date_at.' . $i, $beneficiary->kids[$i]->birth_of_date_at)); ?>"
                                ...
                                <button type="button" class="btn btn-raised btn-raised-primary btn-sm btn-rounded m-1 mt-3"
                                        id="addKid" style="display: <?php echo e($beneficiary->is_has_kids || old('is_has_kids') == true ? 'block' : 'none'); ?>;">&plus;</button>

                                <div class="form-row">
                                    <div class="col-md-6 mb-3">
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox" class="custom-control-input"
                                                   id="isActive" <?php echo e($beneficiary->is_active == true || old('is_active') == true ? 'checked' : ''); ?>

                                                   name="is_active" value="<?php echo e($beneficiary->is_active == true || old('is_active') == true ? 1 : 0); ?>">
...
<?php $__env->startSection('scripting...'); ?>
    <script>
        ...
        var counter = parseInt('<?php echo $beneficiary->kids()->count(); ?>');
        ...
        const oldIdentityValue = '<?php echo $beneficiary->identity_number; ?>';
...
<?php echo $__env->make('admin::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/forsama1/public_html/waqf/Modules/Admin/Resources/views/users/beneficiaries/edit.blade.php ENDPATH**/ ?>