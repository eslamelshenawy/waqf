                                        ...
                                        <?php $__currentLoopData = @$data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $box): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <?php if($box->balances != null): ?>
                                                 ...
                                                 <td scope="row"><?php echo e(@$box->balances->debit -@$box->balances->credit); ?></td>
                                                    <?php else: ?>
                                                        <td scope="row">0</td>
                                                    <?php endif; ?>
                                                <?php elseif($type == "agency"): ?>
...
<?php echo $__env->make('accounting::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/forsama1/public_html/waqf/Modules/Accounting/Resources/views/Receivables/index.blade.php ENDPATH**/ ?>