        ...
        <div class="container" id="tenantContainer">
            <div class="row">
                <div class="col-md-12">
                    <div class="card mb-4">
                        <div class="card-body">
                            <div class="card-title"><br><h4><?php echo e(__('shared::estates.edit_apartment')); ?></h4><br></div>
                            <hr>
                            <form class="needs-validation" novalidate method="POST" action="<?php echo e(route('Admin::apartments.update', $apartment->id)); ?>" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                ...
                                <div class="form-row">
                                    <div id="buildingsDiv" class="col-md-4 mb-4" style="display: block;">
                                        ...
                                        <?php echo $__env->make('admin::lists._buildings', ['selected_id' => $apartment->parent_id], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                    ...
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <select class="form-control" name="city">
                                            <?php $__currentLoopData = $city->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($c->name_en); ?>" <?php echo e(old('city') == $c->name_en || $c->id == $apartment->city_id ? 'selected' : ''); ?>><?php echo e($c->name_ar); ?></option>
...
unset($__errorArgs, $__bag); ?>"
                                               name="number" value="<?php echo e(old('number', $apartment->number)); ?>" id="number"maxlength="10"
...
unset($__errorArgs, $__bag); ?>"
                                               name="space" value="<?php echo e(old('space', $apartment->space)); ?>" id="name"
...
unset($__errorArgs, $__bag); ?>"
                                               name="price" value="<?php echo e(old('price', $apartment->price)); ?>"
                                               id="price" placeholder="<?php echo e(__('shared::commons.price')); ?>" maxlength="9">
...
unset($__errorArgs, $__bag); ?>"
                                               name="floor_number" value="<?php echo e(old('floor_number', $apartment->floor_number)); ?>"
                                               id="floorNumber" placeholder="<?php echo e(__('shared::estates.floor_number')); ?>" maxlength="10">
...
unset($__errorArgs, $__bag); ?>" name="number_of_rooms"
                                                           id="numberOfRoom" value="<?php echo e(old('number_of_rooms', $apartment->number_of_rooms)); ?>" placeholder="0" required></td>
...
unset($__errorArgs, $__bag); ?>" name="number_of_toilets"
                                                           id="numberOfToilets" value="<?php echo e(old('number_of_toilets', $apartment->number_of_toilets)); ?>" placeholder="0" required></td>
...
unset($__errorArgs, $__bag); ?>" name="number_of_kitchens"
                                                           id="numberOfKitchens" value="<?php echo e(old('number_of_kitchens', $apartment->number_of_kitchens)); ?>" placeholder="0" required></td>
                                            </tr>
                                        </table>
                                    </div>
                                </div>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-3 mb-3 mt-4">
                                        <input type="radio" value="1" class="form-check-inline"
                                               ...
                                               onchange="isHasAirConditioner(this.value)" <?php echo e(old('is_has_air_conditioner', $apartment->is_has_air_conditioner) == '1' ? 'checked' : ''); ?> />
                                    ...
                                    <div class="col-md-3 mb-3 mt-4">
                                        <input type="radio" value="0" class="form-check-inline"
                                               ...
                                               onchange="isHasAirConditioner(this.value)" <?php echo e(old('is_has_air_conditioner', $apartment->is_has_air_conditioner) == '0' ? 'checked' : ''); ?>>
                                        <label for="isHasAirConditionerNo">&nbsp;&nbsp;<?php echo e(__('shared::commons.no')); ?></label>
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="col-md-2 mb-3 mt-3" id="numberOfAirConditionerDiv" style="display: <?php echo e(old('is_has_air_conditioner', $apartment->is_has_air_conditioner) == '1' ? 'block' : 'none'); ?>;">
                                        <label for="numberOfAirConditioner">&nbsp;&nbsp;<?php echo e(__('shared::estates.number_of_conditioners')); ?></label>
                                        <input type="number" name="number_of_air_conditioner" value="<?php echo e(old('number_of_air_conditioner', $apartment->number_of_air_conditioner)); ?>"
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-3 mb-3 mt-4">
                                        <input type="radio" value="1" <?php echo e(old('is_kitchen_ready', $apartment->is_kitchen_ready) == '1' ? 'checked' : ''); ?>
                                    ...
                                    <div class="col-md-3 mb-3 mt-4">
                                        <input type="radio" value="0" <?php echo e(old('is_kitchen_ready', $apartment->is_kitchen_ready) == '0' ? 'checked' : ''); ?>
                                ...
                                <div class="form-row">
                                    <div class="col-md-6 mb-3 mt-3" id="kitchenDetailsDiv" style="display: <?php echo e(old('is_kitchen_ready', $apartment->is_kitchen_ready) == '1' ? 'block' : 'none'); ?>;">
                                        <label for="kitchenDetails"><?php echo e(__('shared::estates.kitchen_details')); ?></label>
                                        <textarea name="kitchen_details" class="form-check-inline form-control mt-2" id="kitchenDetails" rows="4"><?php echo e(old('kitchen_details', $apartment->kitchen_details)); ?></textarea>
                                    </div>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-3 mb-3 mt-4">
                                        <input type="radio" value="1" <?php echo e(old('is_has_parking', $apartment->is_has_parking) == '1' ? 'checked' : ''); ?>
                                    ...
                                    <div class="col-md-3 mb-3 mt-4">
                                        <input type="radio" value="0" <?php echo e(old('is_has_parking', $apartment->is_has_parking) == '0' ? 'checked' : ''); ?>
                                ...
                                <div class="form-row">
                                    <div class="col-md-3 mb-3 mt-3" id="parkingNumberDiv" style="display: <?php echo e(old('is_has_parking', $apartment->is_has_parking) == '1' ? 'block' : 'none'); ?>;">
                                        <label for="parkingNumber">&nbsp;&nbsp;<?php echo e(__('shared::estates.parking_number')); ?></label>
                                        <input type="text" name="parking_number" class="form-check-inline form-control" id="parkingNumber" value="<?php echo e(old('parking_number', $apartment->parking_number)); ?>">
                                    </div>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-check form-check-inline col-md-2 mt-4">
                                        <input class="form-check-input" type="radio"
                                               name="rent_type" <?php echo e(old('rent_type', $apartment->rent_type) == 'monthly' ? 'checked' : ''); ?>
                                    ...
                                    <div class="form-check form-check-inline col-md-2 mt-4">
                                        <input class="form-check-input" type="radio"
                                               name="rent_type" <?php echo e(old('rent_type', $apartment->rent_type) == 'quarterly' ? 'checked' : ''); ?>
                                    ...
                                    <div class="form-check form-check-inline col-md-2 mt-4">
                                        <input class="form-check-input" type="radio"
                                               name="rent_type" <?php echo e(old('rent_type', $apartment->rent_type) == 'midterm' ? 'checked' : ''); ?>
                                    ...
                                    <div class="form-check form-check-inline col-md-2 mt-4">
                                        <input class="form-check-input" type="radio"
                                               name="rent_type" <?php echo e(old('rent_type', $apartment->rent_type) == 'yearly' ? 'checked' : ''); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <textarea class="form-control" name="extra_details" id="extraDetails" rows="8"><?php echo e(old('extra_details', $apartment->extra_details)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-row">
                                    <div class="col-md-12">
                                        <label><?php echo e(__('shared::estates.current_apartment_images')); ?></label>
                                    </div>
                                ...
                                <div class="form-row">
                                    <div class="col-md-6 mb-3">
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox" class="custom-control-input" id="isActive" name="is_active" value="1" <?php echo e($apartment->is_active ? 'checked' : ''); ?>>
                                            <label class="custom-control-label" for="isActive"><?php echo e(__('shared::commons.active')); ?></label>
                                        </div>
                                    </div>
                                </div>
                                <button type="submit" class="btn btn-raised btn-raised-primary btn-rounded m-1 mt-3"><?php echo e(__('shared::actions.update')); ?></button>
                            </form>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('admin::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/forsama1/public_html/waqf/Modules/Admin/Resources/views/estates/apartments/edit.blade.php ENDPATH**/ ?>