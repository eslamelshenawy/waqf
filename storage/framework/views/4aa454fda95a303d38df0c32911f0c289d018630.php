                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <form class="needs-validation" novalidate method="post"
                                  action="<?php echo e(route('Accounting::vouchers.receipts.update', $voucher->id)); ?>" autocomplete="off"
...
unset($__errorArgs, $__bag); ?>"
                                                ...
                                                <option value="سند داخلى" <?php echo e($voucher->voucherable_type == "سند داخلى"  ? "selected" : ""); ?>>سند قبض داخلى</option>
                                                <option value="سند خارجى" <?php echo e($voucher->voucherable_type == "سند خارجى"  ? "selected" : ""); ?>>سند قبض خارجى</option>
                                            </select>
                                        </div>
...
unset($__errorArgs, $__bag); ?>" style=" width: 50%;"
                                            ...
                                            <?php $__currentLoopData = \App\User::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tent): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($tent->id); ?>"
                                                        <?php echo e($voucher->attributable_id == $tent->id  ? "selected" : ""); ?>><?php echo e($tent->name); ?>
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <label class="radio radio-reverse radio-warning">
                                                <input type="radio"
                                                       class="form-control <?php $__errorArgs = ['payment_mode_in'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border border-danger <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-6 mb-2" id="checke_num" style="display: none;">
                                        ...
                                        <input type="text" name="checke_num_in" maxlength="25" class="form-control <?php $__errorArgs = ['checke_num_in'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>border border-danger <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"  value="<?php echo e($voucher->check_num); ?>" id="checke_num"/>
                                    ...
                                    <div class="col-sm-4 form-group mb-3 pl-0" style="display: none;" id="date_Due">
                                        <div class="form-group mb-3">
                                            ...
                                            <input id="order-datepicker2"
                                                   class="form-control text-right  <?php $__errorArgs = ['date_Due_in'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border border-danger <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                                ...
                                                <tr>
                                                    <td><?php echo e(__('accounting::_.receive_amount')); ?></td>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <?php $VocherOutUsers = app('\App\User'); ?>
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <select class="Name_tenant_out form-control select2 <?php $__errorArgs = ['user_id_out'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border border-danger <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" style=" width: 50%;"
                                                name="user_id_out">
                                            <?php $__currentLoopData = $VocherOutUsers->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $VocherOutUser): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-6 mb-2" id="checke_num_out" style="display: none;">
                                        ...
                                        <input type="text" name="checke_num_out" maxlength="24" class="form-control <?php $__errorArgs = ['checke_num_out'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border border-danger <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="checke_num_out"  value="<?php echo e($voucher->check_num); ?>"/>
...
unset($__errorArgs, $__bag); ?>"
                                                                   value="<?php echo e($voucher->account->debit   ? $voucher->account->debit : 0); ?>" readonly>
...
<?php echo $__env->make('accounting::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/forsama1/public_html/waqf/Modules/Accounting/Resources/views/vouchers/receipts/edit.blade.php ENDPATH**/ ?>