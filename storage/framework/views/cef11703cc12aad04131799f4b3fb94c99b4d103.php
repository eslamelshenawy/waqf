        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card mb-4">
                        <div class="card-body">
                            <h4 class="card-title mb-3"><?php echo e(__('shared::actions.manage') . ' ' . __('طلب الحصول على المعلومات')); ?></h4>
                                    ...
                                    <?php if($orderBalance && $orderBalance->count()): ?>
                                        <?php $__currentLoopData = $orderBalance; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $balance): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td scope="row">
                                                    <?php if(auth()->user()->hasRole('super-admin') || auth()->user()->can('delete orderinformations')): ?>

                                                    <form method="get" action="<?php echo e(url('en/dashboard/information/accept')); ?>">
                                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/forsama1/public_html/waqf/Modules/Admin/Resources/views/users/information/index.blade.php ENDPATH**/ ?>