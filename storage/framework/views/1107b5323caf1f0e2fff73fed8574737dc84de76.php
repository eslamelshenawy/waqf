                                        ...
                                        <?php $__currentLoopData = $reservate; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $res): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td scope="row">
                                                    ...
                                                    <?php echo e($res->madeBy->name ? $res->madeBy->name  : $res->madeBy->slug); ?>
                                                ...
                                                <td scope="row">
                                                    ...
                                                    <?php if($res->tenanter != null ): ?>
                                                    
                                                      <?php if(auth()->user()->hasRole('super-admin') || auth()->user()->can('show tenants')): ?>

                                                    <a href="<?php echo e(route('Admin::tenants.show', $res->tenanter->id)); ?>" class="text-success mr-2">
                                                        <?php echo e($res->tenanter->name); ?>
                                                ...
                                                <td scope="row">
                                                    ...
                                                    <form method="get" action="<?php echo e(url('en/dashboard/estates/Reservations/accept')); ?>">
                                                        ...
                                                        <input type="hidden" name="id" value="<?php echo e($res->estate_id); ?>" />
                                                         <?php if($res->tenanter != null ): ?>
...
<?php endif; ?>
                                                        <?php if($res->is_accepted != 0): ?>
                                                            ...
                                                            <?php if(auth()->user()->hasRole('super-admin') ||auth()->user()->can('update accountings')): ?>
                                                                ...
                                                                href="<?php echo e(url('en/accounting/invoices/create')); ?>/<?php echo e($res->amount); ?>/ <?php if($res->tenanter != null ): ?><?php echo e($res->tenanter->id); ?> <?php endif; ?>">
                                                                إصدار فاتوره
                                                                </a>
                                                            <?php endif; ?>
...
<?php echo $__env->make('admin::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/forsama1/public_html/waqf/Modules/Admin/Resources/views/estates/Reservations/index.blade.php ENDPATH**/ ?>