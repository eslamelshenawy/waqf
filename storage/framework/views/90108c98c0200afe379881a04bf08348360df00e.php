                ...
                <div class="col-md-12">
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <hr>
                            <form class="needs-validation" novalidate method="POST" action="<?php echo e(route("Admin::agencies.update", $agency->id)); ?>" autocomplete="off"enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="radio" name="type" value="person" <?php echo e(old('type', $agency->type) === 'person' ? 'checked' : ''); ?>
                                    ...
                                    <div class="col-md-6">
                                        <input type="radio" name="type" value="agency" <?php echo e(old('type', $agency->type) === 'agency' ? 'checked' : ''); ?>
...
unset($__errorArgs, $__bag); ?>"
                                               name="name" value="<?php echo e(old('name', $agency->name)); ?>" id="name" placeholder="<?php echo e(__('shared::commons.name')); ?>">
...
unset($__errorArgs, $__bag); ?>"
                                               ...
                                               value="<?php echo e(old('identity_number', $agency->identity_number)); ?>" id="identityNumber"
...
unset($__errorArgs, $__bag); ?>"
                                               name="email" id="email" value="<?php echo e(old('email', $agency->email)); ?>"
...
unset($__errorArgs, $__bag); ?>"
                                               name="mobile" id="mobile" value="<?php echo e(old('mobile', $agency->mobile)); ?>"
                                    ...
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <select class="form-control" name="city">
                                            <?php $__currentLoopData = $city->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($c->name_en); ?>" <?php echo e(old('city') == $c->name_en || $agency->city_id == $c->id ? 'selected' : ''); ?>><?php echo e($c->name_ar); ?></option>
...
unset($__errorArgs, $__bag); ?>"
                                                  id="address" name="address" rows="4"><?php echo e(old('address', $agency->address)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <?php echo $__env->make('admin::users.agencies.partials._edit_services_radios', ['agency' => $agency], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                <?php else: ?>
                                <?php echo $__env->make('admin::users.agencies.partials._edit_services_checks', ['agency' => $agency], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                             <?php endif; ?>
                                <div class="form-row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox" class="custom-control-input" id="isActive" name="is_active"
                                                   value="<?php echo e(old('is_active') == 1 ? 1 : 0); ?>" <?php echo e($agency->is_active == true ? 'checked' : ''); ?>>
...
<?php echo $__env->make('admin::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/forsama1/public_html/waqf/Modules/Admin/Resources/views/users/agencies/edit.blade.php ENDPATH**/ ?>