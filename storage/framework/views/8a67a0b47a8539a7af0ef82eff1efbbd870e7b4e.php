...
<div style="display: <?php echo e(old('type') == 'agency' || $agency->type == 'agency' ? 'block' : 'none'); ?>;" id="servicesDiv">
    <?php if( ($agency) ): ?>
        <div class="form-row">
            <div class="col-md-12 mb-3">
                ...
                <div class="col-md-3 mb-1">
                    <input type="checkbox" name="services[]" <?php echo e(in_array('electric', $agency->getServices()) == true ? 'checked' : ''); ?>

                    value="electric" class="form-check-inline"  />
                    <label>&nbsp;<?php echo e(__('shared::users.electric')); ?></label>
                </div>
                <div class="col-md-3 mb-1">
                    <input type="checkbox" name="services[]" <?php echo e(in_array('plumber', $agency->getServices()) == true ? 'checked' : ''); ?>

                    value="plumber" class="form-check-inline"  />
                    <label>&nbsp;<?php echo e(__('shared::users.plumber')); ?></label>
                </div>
                <div class="col-md-3 mb-1">
                    <input type="checkbox" name="services[]" <?php echo e(in_array('carpenter', $agency->getServices()) == true ? 'checked' : ''); ?>

                    value="carpenter" class="form-check-inline" />
                    <label>&nbsp;<?php echo e(__('shared::users.carpenter')); ?></label>
                </div>
                <div class="col-md-3 mb-1">
                    <input type="checkbox" name="services[]" <?php echo e(in_array('painter', $agency->getServices()) == true ? 'checked' : ''); ?>

                    value="painter" class="form-check-inline"  />
                    <label>&nbsp;<?php echo e(__('shared::users.painter')); ?></label>
                </div>
                <div class="col-md-3 mb-1">
                    <input type="checkbox" name="services[]" <?php echo e(in_array('paving', $agency->getServices()) == true ? 'checked' : ''); ?>

                    value="paving" class="form-check-inline"  />
                    <label>&nbsp;<?php echo e(__('shared::users.paving')); ?></label>
                </div>
                <div class="col-md-3 mb-1">
                    <input type="checkbox" name="services[]" <?php echo e(in_array('transfer_furniture', $agency->getServices()) == true ? 'checked' : ''); ?>

                    value="transfer_furniture" class="form-check-inline"  />
                    <label>&nbsp;<?php echo e(__('shared::users.transfer_furniture')); ?></label>
                </div>
                <div class="col-md-3 mb-1">
                    <input type="checkbox" name="services[]" <?php echo e(in_array('uploading_and_downloading', $agency->getServices()) == true ? 'checked' : ''); ?>

                    value="uploading_and_downloading" class="form-check-inline" />
                    <label>&nbsp;<?php echo e(__('shared::users.uploading_and_downloading')); ?></label>
                </div>
                <div class="col-md-3 mb-1">
                    <input type="checkbox" name="services[]" <?php echo e(in_array('cleaning', $agency->getServices()) == true ? 'checked' : ''); ?>
                ...
                <div class="col-md-12 mb-1">
                    <input type="checkbox" name="services[]"
                           value="other" <?php echo e(in_array('other', $agency->getServices()) == true ? 'checked' : ''); ?>
                ...
                <div class="col-md-3 mb-1"  style="display: <?php echo e(checkbox('services', 9, 'other') == true ? 'block' : 'none'); ?>" id="otherServicesDiv">
                    <input type="text" class="form-check-inline checkbox" name="service_other"
                           value="<?php echo e(old('service_other', $agency->service_other)); ?>"
    ...
    <?php endif; ?>
    <hr>
</div><?php /**PATH /home1/forsama1/public_html/waqf/Modules/Admin/Resources/views/users/agencies/partials/_edit_services_checks.blade.php ENDPATH**/ ?>