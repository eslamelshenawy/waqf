...
<div class="app-admin-wrap layout-sidebar-large clearfix">
        ...
        <div class="header-part-right">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu rtl-ps-none dropdown-menu-right notification-dropdown" aria-labelledby="dropdownNotification" data-perfect-scrollbar data-suppress-scroll-x="true">
                    <?php $__currentLoopData = $Notifications->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="dropdown-item d-flex">
                            ...
                            <div class="notification-details flex-grow-1">
                                ...
                                <p class="text-small text-muted m-0"><?php echo e(json_decode($notification->data)->message); ?></p>
                            </div>
                        </div>
    ...
    <!--=============== Left side End ================-->
<?php /**PATH C:\xampp\htdocs\waqf\Modules/Accounting\Resources/views/layouts/header.blade.php ENDPATH**/ ?>