...
<?php endif; ?>
            <div class="row">
                <div class="col-md-12">
                    <div class="card mb-4">
                        <div class="card-body">
                            <h4 class="card-title mb-3"><?php echo e(__('shared::actions.manage') . ' ' . __('shared::users.the_tenants')); ?></h4>
                            <div class="table-responsive">
                                    ...
                                    <?php if($tenants && $tenants->count()): ?>
                                        <?php $__currentLoopData = $tenants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $tenant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td scope="row"><?php echo e($tenant->name); ?></td>
                                                <td scope="row"><?php echo e($tenant->status); ?></td>

                                                <td scope="row">
                                                    
                                                    <?php if(auth()->user()->hasRole('super-admin') || auth()->user()->can('update tenants')): ?>

                                                    <a href="<?php echo e(route('Admin::tenants.edit', $tenant->id)); ?>" class="text-success mr-2">
                                                    ...
                                                    <a href="<?php echo e(route('Admin::tenants.show', $tenant->id)); ?>" class="text-success mr-2">
                                                        <i class="fa fa-eye font-weight-bold"></i>
                                                    </a>
                                                    <?php endif; ?>
                                                        <?php if(auth()->user()->hasRole('super-admin') || auth()->user()->can('delete tenants')): ?>

                                                        <form style="display: none;" method="POST" action="<?php echo e(route('Admin::tenants.destroy', $tenant->id)); ?>"
                                                          id="form-<?php echo e($tenant->id); ?>">
                                                        <?php echo csrf_field(); ?>
                                                        <?php echo method_field('DELETE'); ?>
                                                    </form>
                                                    <a href="JavaScript:void(0);" class="text-danger mr-2"
                                                       onclick="deleteTenant(<?php echo $tenant->id; ?>)">
                                ...
                                <?php if(auth()->user()->hasRole('super-admin') || auth()->user()->can('create tenants')): ?>
                                <a type="submit" class="btn btn-raised btn-raised-primary btn-lg btn-rounded m-1 mt-3 btn-sm" href="<?php echo e(route('Admin::tenants.create')); ?>">&plus; <?php echo e(__('shared::actions.new')); ?></a>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('admin::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/forsama1/public_html/waqf/Modules/Admin/Resources/views/users/tenants/index.blade.php ENDPATH**/ ?>