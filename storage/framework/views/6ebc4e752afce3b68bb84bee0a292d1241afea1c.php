...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input type="text" maxlength="10" value="<?php echo e(old('identity_number')); ?>" class="form-control <?php $__errorArgs = ['identity_number'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border border-danger <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="tel" maxlength="10" placeholder="" value="<?php echo e(old('mobile')); ?>" class="form-control <?php $__errorArgs = ['mobile'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border border-danger <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="date" name="birth_of_date_at" value="<?php echo e(old('birth_of_date_at')); ?>"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input type="date" name="release_at" value="<?php echo e(old('release_at')); ?>"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input type="date" name="end_at" value="<?php echo e(old('end_at')); ?>" class="form-control <?php $__errorArgs = ['end_at'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border border-danger <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('password')); ?>" name="password" id="password" />
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input type="text" value="<?php echo e(old('job_title')); ?>" class="form-control <?php $__errorArgs = ['job_title'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border border-danger <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="company_name" id="companyName" value="<?php echo e(old('company_name')); ?>"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" name="bank_iban_number" maxlength="25" value="<?php echo e(old('bank_iban_number')); ?>"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" name="bank_account_number" id="bankAccountNumber" maxlength="14" value="<?php echo e(old('bank_account_number')); ?>"
                        ...
                        <div id="kid-0">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="kid_identity_number[]" maxlength="10"autocomplete="off" id="kidIdentityNumber" placeholder="<?php echo e(__('shared::commons.identity_number')); ?>">
                                </div>
                            </div>
...
<?php echo $__env->make('client::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/forsama1/public_html/waqf/Modules/Client/Resources/views/users/beneficiaries/create.blade.php ENDPATH**/ ?>