                            ...
                            <div class="col-md-12">
                                <?php switch($estate->estate_type):
                                    ...
                                    <dl >
                                        ...
                                        <dd class="col-sm-4"> <?php echo e(($estate->space)); ?><sup>2</sup></dd>
                                        <dt class="col-sm-4">شقه</dt>
                                        <dd class="col-sm-4"> <?php echo e(($estate->number_of_apartments)); ?></dd>
                                        <dt class="col-sm-4">طابق</dt>
                                        <dd class="col-sm-4"> <?php echo e(($estate->number_of_floors)); ?></dd>
                                        <dt class="col-sm-4">محل</dt>
                                        <dd class="col-sm-4"> <?php echo e(($estate->number_of_shops)); ?></dd>
                                        <dt class="col-sm-4">نوع الايجار</dt>
                                        <dd class="col-sm-4"> <?php echo e(($estate->rent_type) == "monthly" ? "شهرى" : ""); ?><?php echo e(($estate->rent_type) == "quarterly" ? "ربع سنوى" : ""); ?><?php echo e(($estate->rent_type) == "midterm" ? "نصف سنوى" : ""); ?><?php echo e(($estate->rent_type) == "yearly" ? "سنوى" : ""); ?></dd>
                                    ...
                                    <dl >
                                        ...
                                        <dd class="col-sm-4"> <?php echo e(($estate->number_of_rooms)); ?></dd>
                                        <dt class="col-sm-4">حمام</dt>
                                        <dd class="col-sm-4"> <?php echo e(($estate->number_of_kitchens)); ?></dd>
                                        <dt class="col-sm-4">مطبخ</dt>
                                        <dd class="col-sm-4"> <?php echo e(($estate->number_of_floors)); ?></dd>
                                        <dt class="col-sm-4">تكيف</dt>
                                        <dd class="col-sm-4"> <?php echo e(($estate->number_of_air_conditioner)); ?></dd>
                                        <dt class="col-sm-4">نوع الايجار</dt>
                                        <dd class="col-sm-4"> <?php echo e(($estate->rent_type) == "monthly" ? "شهرى" : ""); ?><?php echo e(($estate->rent_type) == "quarterly" ? "ربع سنوى" : ""); ?><?php echo e(($estate->rent_type) == "midterm" ? "نصف سنوى" : ""); ?><?php echo e(($estate->rent_type) == "yearly" ? "سنوى" : ""); ?></dd>
                                    </dl>
...
<?php echo $__env->make('client::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/forsama1/public_html/waqf/Modules/Client/Resources/views/estates/show.blade.php ENDPATH**/ ?>