                ...
                <div class="card mb-4">
                    ...
                    <div class="table-responsive">
                                    ...
                                    <tr>
                                                ...
                                                <td>
                                                    <?php if(auth()->user()->hasRole('super-admin') ||auth()->user()->can('update vouchers')): ?>
                                                        <a href="<?php echo e(route('Accounting::vouchers.payments.edit', $voucher->id)); ?>" class="text-success mr-2">
                        ...
                        <?php if(auth()->user()->hasRole('super-admin') ||auth()->user()->can('create vouchers')): ?>
                            <a class="btn btn-raised btn-raised-primary btn-rounded m-1" href="<?php echo e(route('Accounting::vouchers.payments.create')); ?>">&plus; add</a>
                        <?php endif; ?>
                        </div>
...
<?php echo $__env->make('accounting::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/forsama1/public_html/waqf/Modules/Accounting/Resources/views/vouchers/payments/index.blade.php ENDPATH**/ ?>