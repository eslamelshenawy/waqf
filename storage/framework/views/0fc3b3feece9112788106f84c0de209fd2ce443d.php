        ...
        <div class="container" id="tenantContainer">
            <div class="row">
                <div class="col-md-12">
                    <div class="card mb-4">
                        <div class="card-body">
                            <div class="card-title"><br><h4><?php echo e(__('shared::estates.new_shop')); ?></h4><br></div>
                            <hr>
                            <form class="needs-validation" novalidate method="POST" action="<?php echo e(route('Admin::shops.store')); ?>" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                <div class="form-row">
...
unset($__errorArgs, $__bag); ?>"
                                               ...
                                               id="shopPrice" placeholder="<?php echo e(__('shared::commons.price')); ?>">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-row">
                                    <div class="col-md-8 mb-3">
                                        ...
                                        <input type="text" name="commercial_activities" value="<?php echo e(old('commercial_activities')); ?>"
...
unset($__errorArgs, $__bag); ?>" name="extra_details" id="extraDetails" rows="8"><?php echo e(old('extra_details')); ?></textarea>
...
<?php echo $__env->make('admin::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\waqf\Modules/Admin\Resources/views/estates/shops/create.blade.php ENDPATH**/ ?>