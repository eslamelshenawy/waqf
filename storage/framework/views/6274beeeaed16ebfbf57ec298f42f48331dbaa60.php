                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <div class="card-title">
                                <br><h4><?php echo e(__('shared::actions.edit')  . ' ' . __('shared::users.tenant')); ?></h4><br></div>
                            <hr>

                            <form class="needs-validation" novalidate method="POST" action="<?php echo e(route("Admin::tenants.update", $tenant->id)); ?>" autocomplete="off">
                                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                               name="name" value="<?php echo e(old('name', $tenant->name)); ?>" id="name" placeholder="<?php echo e(__('shared::commons.name')); ?>">
...
unset($__errorArgs, $__bag); ?>"
                                               name="email" id="email" value="<?php echo e(old('email', $tenant->email)); ?>"
...
unset($__errorArgs, $__bag); ?>"
                                               name="mobile" id="mobile" value="<?php echo e(old('mobile', $tenant->mobile)); ?>"
                                    ...
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <select class="form-control" name="city">
                                            <?php $__currentLoopData = $city->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($c->name_en); ?>"
                                                        <?php echo e(old('city') == $c->name_en || $tenant->city_id == $c->id ? 'selected' : ''); ?>><?php echo e($c->name_ar); ?></option>
...
unset($__errorArgs, $__bag); ?>"
                                               name="identity_number" value="<?php echo e(old('identity_number', $tenant->identity_number)); ?>" autocomplete="off"
...
unset($__errorArgs, $__bag); ?>"
                                               name="birth_of_date_at" value="<?php echo e(old('birth_of_date_at', $tenant->birth_of_date_at)); ?>" autocomplete="off" id="birthOfDateAt"
...
unset($__errorArgs, $__bag); ?>"
                                               name="release_at" value="<?php echo e(old('release_at', $tenant->release_at)); ?>"
...
unset($__errorArgs, $__bag); ?>"
                                               name="end_at" value="<?php echo e(old('end_at', $tenant->end_at)); ?>" autocomplete="off" id="endAt"
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-row">
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <?php echo $__env->make('admin::lists._jobs', ['job' => old('job', $tenant->job)], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                        <?php $__errorArgs = ['job'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-3 mb-3" id="jobTitleOtherDiv" style="display: none;">
                                        ...
                                        <input type="text" name="job_title_other" value="<?php echo e(old('job_title_other', $tenant->job_title_other)); ?>"
...
unset($__errorArgs, $__bag); ?>"
                                               id="jobTitleOther" placeholder="<?php echo e(__('shared::commons.job_title')); ?>" autocomplete="off" required>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-4 mb-4">
                                        ...
                                        <select class="field form-control" name="account_status" id="account_status">
                                            <option value="pending" <?php echo e($tenant->status == 'pending' ? 'selected' : ''); ?>><?php echo e(__('shared::commons.pending')); ?></option>
                                            <option value="confirmed" <?php echo e($tenant->status == 'confirmed' ? 'selected' : ''); ?>><?php echo e(__('shared::commons.confirmed')); ?></option>
                                            <option value="suspended" <?php echo e($tenant->status == 'suspended' ? 'selected' : ''); ?>><?php echo e(__('shared::commons.suspended')); ?></option>
                                        </select>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-4 mb-4">
                                        ...
                                        <select class="field form-control" name="marital_status" id="maritalStatus">
                                            <option value="single" <?php echo e(old('marital_status', $tenant->marital_status) == 'single' ? 'selected' : ''); ?>><?php echo e(__('shared::commons.single')); ?></option>
                                            <option value="married" <?php echo e(old('marital_status', $tenant->marital_status) == 'married' ? 'selected' : ''); ?>><?php echo e(__('shared::commons.married')); ?></option>
                                            <option value="widower" <?php echo e(old('marital_status', $tenant->marital_status) == 'widower' ? 'selected' : ''); ?>><?php echo e(__('shared::commons.widower')); ?></option>
                                            <option value="divorcee" <?php echo e(old('marital_status', $tenant->marital_status) == 'divorcee' ? 'selected' : ''); ?>><?php echo e(__('shared::commons.divorcee')); ?></option>
                                        </select>

                                    </div>
                                </div>

                                <!--<div class="form-row mt-2" id="haveKids" style="display: <?php echo e(old('is_has_kids', $tenant->is_has_kids) ? 'block' : 'none'); ?>;">-->
                                <!--    <div class="col-md-6 mb-3">-->
                                ...
                                <!--                       id="kidsYes" name="is_has_kids" <?php echo e(old('is_has_kids', $tenant->is_has_kids) == true ? 'checked' : ''); ?> required>-->
                                ...
                                <!--                       name="is_has_kids" <?php echo e(old('is_has_kids', $tenant->is_has_kids) == false ? 'checked' : ''); ?> required>-->
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox" class="custom-control-input"
                                                   id="isActive" <?php echo e($tenant->is_active == true || old('is_active') == true ? 'checked' : ''); ?>

                                                   name="is_active" value="<?php echo e($tenant->is_active == true || old('is_active') == true ? 1 : 0); ?>">
...
<?php $__env->startSection('scripting...'); ?>
    <script>
        ...
        var counter = parseInt('<?php echo $tenant->kids()->count(); ?>');
        ...
        const oldIdentityValue = '<?php echo $tenant->identity_number; ?>';
...
<?php echo $__env->make('admin::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/forsama1/public_html/waqf/Modules/Admin/Resources/views/users/tenants/edit.blade.php ENDPATH**/ ?>