...
// var loggedIn = '<?php echo e(Auth::guard('beneficiary')->check() ? 'true' : 'false'); ?>';
 var agency = '<?php echo e(Auth::guard('agency')->check()); ?>';
 var beneficiary = '<?php echo e(Auth::guard('beneficiary')->check()); ?>';
 var admin = '<?php echo e(Auth::guard('admin')->check()); ?>';
...
<?php /**PATH /home1/forsama1/public_html/waqf/Modules/Client/Resources/views/layouts/footer.blade.php ENDPATH**/ ?>