...
class InformationController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin::users.information.index', ['orderBalance' => OrderInformation::with('madeBy')->get()]);
    }
    ...
    {
        $orderBalance=OrderInformation::where("beneficiary_id",$request->id)->first();
