        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card mb-4">
                        <div class="card-body">
                            <h4 class="card-title mb-3">{{ __('shared::actions.manage') . ' ' . __(' قائمة الدخل') }}</h4>
...
{{--                                            <td></td>--}}
                                        ...
                                        @inject('Banks', '\Modules\Accounting\Entities\BankBalance   ')
                                        @inject('FundBalance', '\Modules\Accounting\Entities\FundBalance')
                                        ...
                                        <tr>
                                            ...
                                            <td>{{($RevenueapartmentsSumMoveCredit  - $RevenueapartmentsSumMoveDebit) >0 ? $RevenueapartmentsSumMoveCredit  - $RevenueapartmentsSumMoveDebit : ""  }}</td>
                                        </tr>
                                        <tr>
                                            <td><span>ايراد المبانى </span>
                                            </td>
                                            <td>{{ $BuildingrevenuesSumMoveCredit  - $BuildingrevenuesSumMoveDebit   }}</td>
                                        </tr>
                                        <tr>
                                            <td><span>ايراد الاراضى </span>
                                            </td>
                                            <td>{{($LandrevenueSumMoveCredit  - $LandrevenueSumMoveDebit) >0 ? $LandrevenueSumMoveCredit  - $LandrevenueSumMoveDebit : ""  }}</td>
                                        </tr>
                                        <tr>
                                            <td><span>ايراد المحلات </span>
                                            </td>
                                            <td scope="row">{{$RevenuestoresSumMoveCredit  - $RevenuestoresSumMoveDebit  }}</td>
                                        </tr>
                                        <tr>
                                            <td><span>ايرادات اخري </span>
                                            </td>
{{--                                            <td scope="row">{{($Otherincome->credit  - $Otherincome->debit) <0 ? $Otherincome->credit  - $Otherincome->debit : ""  }}</td>--}}
...
{{--                                            <td scope="row"--}}
{{--                                                style="    border-style: solid;">{{($sumincomeCedit  - $sumincomeDebit) <0 ? $sumincomeCedit  - $sumincomeDebit : ""  }}</td>--}}
                                            <td scope="row"
                                                style="    border-style: solid;">{{($incomemovesumCredit  - $incomemovesumDebit) >0 ? $incomemovesumCredit  - $incomemovesumDebit : ""  }}</td>
...
{{--                                            <td scope="row">{{($sumEndowmentexpensesDebit -$sumEndowmentexpensesCedit) >0 ? $sumEndowmentexpensesDebit -$sumEndowmentexpensesCedit : ""  }}</td>--}}
                                            <td scope="row">{{$EndowmentexpensesmovesumDebit - $EndowmentexpensesmovesumCredit  }}</td>
                                        </tr>
                                        <tr>
                                            <td><span>مصروفات عموميه واداريه</span>
                                            </td>
{{--                                            <td scope="row">{{($sumGeneraladmiexpensesDebit -$sumGeneraladmiexpensesCedit) >0 ? $sumGeneraladmiexpensesDebit -$sumGeneraladmiexpensesCedit : ""  }}</td>--}}
                                            <td scope="row">{{$GeneraladmiexpensesmovesumDebit - $GeneraladmiexpensesmovesumCredit  }}</td>
                                        </tr>
                                        <tr>
                                            <td><span>مصروفات اهلاك الاصول  </span>
                                            </td>
{{--                                            <td scope="row">{{($sumAssetsdepreciationexpensesDebit -$sumAssetsdepreciationexpensesCedit) >0 ? $sumAssetsdepreciationexpensesDebit -$sumAssetsdepreciationexpensesCedit : ""  }}</td>--}}
...
{{--                                            <td scope="row"--}}
{{--                                                style="    border-style: solid;">{{($sumexpensesDebit -$sumexpensesCedit) >0 ? $sumexpensesDebit -$sumexpensesCedit : ""  }}</td>--}}
                                            <td scope="row"
                                                style="    border-style: solid;">{{($expensesmovesumDebit -$expensesmovesumCredit) > 0 ? $expensesmovesumDebit -$expensesmovesumCredit : ""  }}</td>
                                        </tr>
                                        @php
...
{{--                                            <td>{{$totaldebitincome - $totaldebitexpenses}}</td>--}}
                                            <td>{{$totalcreditincome - $totalcreditexpenses}}</td>
                                        </tr>
