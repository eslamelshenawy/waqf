...
<div style="display: {{ old('type') == 'agency' || $agency->type == 'agency' ? 'block' : 'none' }};" id="servicesDiv">
    @if( ($agency) )
        <div class="form-row">
            <div class="col-md-12 mb-3">
                ...
                <div class="col-md-3 mb-1">
                    <input type="checkbox" name="services[]" {{ in_array('electric', $agency->getServices()) == true ? 'checked' : '' }}
                    value="electric" class="form-check-inline"  />
                    <label>&nbsp;{{ __('shared::users.electric') }}</label>
                </div>
                <div class="col-md-3 mb-1">
                    <input type="checkbox" name="services[]" {{ in_array('plumber', $agency->getServices()) == true ? 'checked' : '' }}
                    value="plumber" class="form-check-inline"  />
                    <label>&nbsp;{{ __('shared::users.plumber') }}</label>
                </div>
                <div class="col-md-3 mb-1">
                    <input type="checkbox" name="services[]" {{ in_array('carpenter', $agency->getServices()) == true ? 'checked' : '' }}
                    value="carpenter" class="form-check-inline" />
                    <label>&nbsp;{{ __('shared::users.carpenter') }}</label>
                </div>
                <div class="col-md-3 mb-1">
                    <input type="checkbox" name="services[]" {{ in_array('painter', $agency->getServices()) == true ? 'checked' : '' }}
                    value="painter" class="form-check-inline"  />
                    <label>&nbsp;{{ __('shared::users.painter') }}</label>
                </div>
                <div class="col-md-3 mb-1">
                    <input type="checkbox" name="services[]" {{ in_array('paving', $agency->getServices()) == true ? 'checked' : '' }}
                    value="paving" class="form-check-inline"  />
                    <label>&nbsp;{{ __('shared::users.paving') }}</label>
                </div>
                <div class="col-md-3 mb-1">
                    <input type="checkbox" name="services[]" {{ in_array('transfer_furniture', $agency->getServices()) == true ? 'checked' : '' }}
                    value="transfer_furniture" class="form-check-inline"  />
                    <label>&nbsp;{{ __('shared::users.transfer_furniture') }}</label>
                </div>
                <div class="col-md-3 mb-1">
                    <input type="checkbox" name="services[]" {{ in_array('uploading_and_downloading', $agency->getServices()) == true ? 'checked' : '' }}
                    value="uploading_and_downloading" class="form-check-inline" />
                    <label>&nbsp;{{ __('shared::users.uploading_and_downloading') }}</label>
                </div>
                <div class="col-md-3 mb-1">
                    <input type="checkbox" name="services[]" {{ in_array('cleaning', $agency->getServices()) == true ? 'checked' : '' }}
                    value="cleaning" class="form-check-inline"  />
                    <label>&nbsp;{{ __('shared::users.cleaning') }}</label>
                </div>
                <div class="col-md-12 mb-1">
                    <input type="checkbox" name="services[]"
                           value="other" {{ in_array('other', $agency->getServices()) == true ? 'checked' : '' }}
                ...
                <div class="col-md-3 mb-1"  style="display: {{ checkbox('services', 9, 'other') == true ? 'block' : 'none' }}" id="otherServicesDiv">
                    <input type="text" class="form-check-inline checkbox" name="service_other"
                           value="{{ old('service_other', $agency->service_other) }}"
