                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <div class="card-title">
                                <br><h4>{{ __('shared::actions.edit')  . ' ' . __('shared::users.tenant') }}</h4><br></div>
                            <hr>

                            <form class="needs-validation" novalidate method="POST" action="{{ route("Admin::tenants.update", $tenant->id) }}" autocomplete="off">
                                @csrf
                                @method('PATCH')
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-4 mb-4">
                                        ...
                                        <input type="text"
                                               ...
                                               name="name" value="{{ old('name', $tenant->name) }}" id="name" placeholder="{{ __('shared::commons.name') }}">
                                        @error('name')
                                        <div>
                                    ...
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <input type="email" class="field form-control @error('email') border border-danger @enderror"
                                               name="email" id="email" value="{{ old('email', $tenant->email) }}"
                                    ...
                                    <div class="col-md-2 mb-2">
                                        ...
                                        <input type="text" maxlength="10"
                                               ...
                                               name="mobile" id="mobile" value="{{ old('mobile', $tenant->mobile) }}"
                                        ...
                                        <select class="form-control" name="city">
                                            @foreach($city->all() as $c)
                                                <option value="{{ $c->name_en }}"
                                                        {{ old('city') == $c->name_en || $tenant->city_id == $c->id ? 'selected' : '' }}>{{ $c->name_ar }}</option>
                                            @endforeach
                                        </select>
                                        @error('city')
                                        <div>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" maxlength="10"
                                               ...
                                               name="identity_number" value="{{ old('identity_number', $tenant->identity_number) }}" autocomplete="off"
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="date" class="field form-control @error('birth_of_date_at') border border-danger @enderror"
                                               name="birth_of_date_at" value="{{ old('birth_of_date_at', $tenant->birth_of_date_at) }}" autocomplete="off" id="birthOfDateAt"
                                    ...
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <input type="date" class="form-control @error('release_at') border border-danger @enderror"
                                               name="release_at" value="{{ old('release_at', $tenant->release_at) }}"
                                    ...
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <input type="date" class="field form-control @error('end_at') border border-danger @enderror"
                                               name="end_at" value="{{ old('end_at', $tenant->end_at) }}" autocomplete="off" id="endAt"
                                ...
                                <div class="form-row">
                                    <div class="col-md-3 mb-3">
                                        ...
                                        @include('admin::lists._jobs', ['job' => old('job', $tenant->job)])
                                        @error('job')
                                        <div>
                                            <span class="badge badge-danger">{{ $message }}</span>
                                        </div>
                                    ...
                                    <div class="col-md-3 mb-3" id="jobTitleOtherDiv" style="display: none;">
                                        ...
                                        <input type="text" name="job_title_other" value="{{ old('job_title_other', $tenant->job_title_other) }}"
                                               class="field form-control @error('job_title_other') border border-danger @enderror"
                                               id="jobTitleOther" placeholder="{{ __('shared::commons.job_title') }}" autocomplete="off" required>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-4 mb-4">
                                        ...
                                        <select class="field form-control" name="account_status" id="account_status">
                                            <option value="pending" {{ $tenant->status == 'pending' ? 'selected' : '' }}>{{ __('shared::commons.pending') }}</option>
                                            <option value="confirmed" {{ $tenant->status == 'confirmed' ? 'selected' : '' }}>{{ __('shared::commons.confirmed') }}</option>
                                            <option value="suspended" {{ $tenant->status == 'suspended' ? 'selected' : '' }}>{{ __('shared::commons.suspended') }}</option>
                                        </select>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-4 mb-4">
                                        ...
                                        <select class="field form-control" name="marital_status" id="maritalStatus">
                                            <option value="single" {{ old('marital_status', $tenant->marital_status) == 'single' ? 'selected' : '' }}>{{ __('shared::commons.single') }}</option>
                                            <option value="married" {{ old('marital_status', $tenant->marital_status) == 'married' ? 'selected' : '' }}>{{ __('shared::commons.married') }}</option>
                                            <option value="widower" {{ old('marital_status', $tenant->marital_status) == 'widower' ? 'selected' : '' }}>{{ __('shared::commons.widower') }}</option>
                                            <option value="divorcee" {{ old('marital_status', $tenant->marital_status) == 'divorcee' ? 'selected' : '' }}>{{ __('shared::commons.divorcee') }}</option>
                                        </select>

                                    </div>
                                </div>

                                <!--<div class="form-row mt-2" id="haveKids" style="display: {{ old('is_has_kids', $tenant->is_has_kids) ? 'block' : 'none' }};">-->
                                <!--    <div class="col-md-6 mb-3">-->
                                ...
                                <!--                       id="kidsYes" name="is_has_kids" {{ old('is_has_kids', $tenant->is_has_kids) == true ? 'checked' : '' }} required>-->
                                ...
                                <!--                       name="is_has_kids" {{ old('is_has_kids', $tenant->is_has_kids) == false ? 'checked' : '' }} required>-->
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox" class="custom-control-input"
                                                   id="isActive" {{ $tenant->is_active == true || old('is_active') == true ? 'checked' : '' }}
                                                   name="is_active" value="{{ $tenant->is_active == true || old('is_active') == true ? 1 : 0 }}">
...
@section('scripting...')
    <script>
        ...
        var counter = parseInt('{!! $tenant->kids()->count() !!}');
        ...
        const oldIdentityValue = '{!! $tenant->identity_number !!}';
