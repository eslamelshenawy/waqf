        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card mb-4">
                        <div class="card-body">
                            <h4 class="card-title mb-3">{{ __('shared::actions.manage') . ' ' . __('طلب الحصول على المعلومات') }}</h4>
                                    ...
                                    @if($orderBalance && $orderBalance->count())
                                        @foreach($orderBalance as $key => $balance)
                                            <tr>
                                                ...
                                                <td scope="row">
                                                    @if(auth()->user()->hasRole('super-admin') || auth()->user()->can('delete orderinformations'))

                                                    <form method="get" action="{{ url('en/dashboard/information/accept') }}">
                                                        @csrf
                                                        @method('get')
