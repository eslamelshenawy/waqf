                        ...
                        <div class="card-body">
                            ...
                            <form class="needs-validation" novalidate method="POST"
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-3 mb-2">
                                        ...
                                        <input type="text" class="field form-control @error('number') border border-danger @enderror"
                                               name="number"
                                               id="number" value="{{ old('number', $building->number) }}" placeholder="{{ __('shared::commons.number') }}" required>
                                        @error('number')
                                        <div>
                                            <span class="badge badge-danger">{{ $message }}</span>
                                        </div>
                                    ...
                                    <div class="col-md-3 mb-2">
                                        ...
                                        <input type="text" class="field form-control @error('space') border border-danger @enderror" name="space"
                                               id="space" value="{{ old('space', $building->space) }}"
                                ...
                                <div class="col-lg-8">
                                    ...
                                    <input type="text" id="searchMapInput" name="searchmab" value="{{$building->searchmab}}" class="form-control map-input">
                                    <div class="col-sm-10">
                                ...
                                <div class="col-lg-8">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <input type="text" id="lat" name="lat" value="{{$building->lat}}" class="form-control map-input">
                                    </div>
                                </div>
                                <div class="col-lg-8">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <input type="text" id="lng" name="lng" value="{{$building->lng}}" class="form-control map-input">
                                    </div>
                                </div>
