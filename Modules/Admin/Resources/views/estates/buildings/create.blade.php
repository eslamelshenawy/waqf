                ...
                <div class="card mb-4">
                    ...
                    <form class="needs-validation" novalidate method="POST"
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-3 mb-2">
                                ...
                                <input type="text" class="field form-control @error('number') border border-danger @enderror"
                                       name="number"
                                       id="number" value="{{ old('number') }}" placeholder="{{ __('shared::commons.number') }}"maxlength="10" required>
                                @error('number')
                                <div>
                                    <span class="badge badge-danger">{{ $message }}</span>
                                </div>
                            ...
                            <div class="col-md-3 mb-2">
                                ...
                                <input type="text" class="field form-control @error('space') border border-danger @enderror" name="space"
                                       ...
                                       placeholder="{{ __('shared::commons.space') }}"maxlength="10" required>
                                @error('space')
                                <div>
                                    <span class="badge badge-danger">{{ $message }}</span>
                                </div>
                            ...
                            <div class="col-md-3 mb-2">
                                ...
                                <input type="text" class="field form-control @error('price') border border-danger @enderror" maxlength="9" name="price"
                       ...
                       <hr>
                        ...
                        <hr>
                        <label>صوره</label>
                        @uploader(['field' => 'instrument_image', 'title' => __('اختار صوره')])
