                ...
                <div class="col-md-12">
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <div class="card-title"><br><h4>{{ __('shared::estates.building', ['something' => __('shared::actions.edit')]) }}</h4><br></div>
                            <hr>
                            <form class="needs-validation" novalidate method="POST"
                                  action="{{ route('Admin::buildings.update', $building->id) }}"
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-6 mb-2">
                                        ...
                                        <input type="text" class="field form-control @error('name') border border-danger @enderror" name="name"
                                               id="name" value="{{ old('name', $building->name) }}"
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <select class="form-control" name="city">
                                            ...
                                            @foreach($city->all() as $c)
                                                <option value="{{ $c->name_en }}" {{ old('city') == $c->name_en || $building->city_id == $c->id ? 'selected' : '' }}>{{ $c->name_ar }}</option>
                                            @endforeach
                                        </select>
                                        @error('city')
                                        <div>
                                    ...
                                    <div class="col-md-5 mb-2">
                                        ...
                                        <input type="text" class="field form-control @error('district') border border-danger @enderror"
                                               name="district"
                                               id="district" value="{{ old('district', $building->district) }}" placeholder="{{ __('shared::estates.district') }}" required>
                                        @error('district')
                                        <div>
                                            <span class="badge badge-danger">{{ $message }}</span>
                                        </div>
                                    ...
                                    <div class="col-md-5 mb-2">
                                        ...
                                        <input type="text" class="field form-control @error('street') border border-danger @enderror" name="street"
                                               id="street" value="{{ old('street', $building->street) }}" placeholder="{{ __('shared::estates.street') }}" required>
                                        @error('street')
                                        <div>
                                            <span class="badge badge-danger">{{ $message }}</span>
                                        </div>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-3 mb-2">
                                        ...
                                        <input type="text" class="field form-control @error('number') border border-danger @enderror"
                                               name="number"
                                               id="number" value="{{ old('number', $building->number) }}" placeholder="{{ __('shared::commons.number') }}"maxlength="10" required>
                                        @error('number')
                                        <div>
                                            <span class="badge badge-danger">{{ $message }}</span>
                                        </div>
                                    ...
                                    <div class="col-md-3 mb-2">
                                        ...
                                        <input type="text" class="field form-control @error('space') border border-danger @enderror" name="space"
                                               id="space" value="{{ old('space', $building->space) }}"maxlength="10"
                                    ...
                                    <div class="col-md-3 mb-2">
                                        ...
                                        <input type="text" class="field form-control @error('price') border border-danger @enderror" name="price" maxlength="9"
                                               id="price" value="{{ old('price', $building->price) }}" placeholder="{{ __('shared::commons.price') }}" required>
                                        @error('price')
                                        <div>
                                            <span class="badge badge-danger">{{ $message }}</span>
                                        </div>
                                        ...
                                        <table class="table table-borderless text-center">
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="number" maxlength="10" class="field form-control @error('number_of_apartments') border border-danger @enderror" name="number_of_apartments"
                                                           id="numberOfApartments" value="{{ old('number_of_apartments', $building->number_of_apartments) }}" placeholder="0" required></td>
                                                <td><input type="number" maxlength="10" class="field form-control @error('number_of_floors') border border-danger @enderror" name="number_of_floors"
                                                           id="numberOfFloors" value="{{ old('number_of_floors', $building->number_of_floors) }}" placeholder="0" required></td>
                                                <td><input type="number" maxlength="10" class="field form-control @error('number_of_shops') border border-danger @enderror" name="number_of_shops" id="numberOfShops"
                                                           value="{{ old('number_of_shops', $building->number_of_shops) }}" placeholder="0" required></td>
                                            </tr>
                                        </table>
                                    </div>
                                </div>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-4 mb-1">
                                        ...
                                        <input type="text"
                                               ...
                                               id="instrumentNumber" value="{{ old('instrument_number', $building->instrument_number) }}"
                                               placeholder="{{ __('shared::estates.instrument_number') }}"maxlength="10" required>
                                    ...
                                    <div class="col-md-3 mb-1">
                                        ...
                                        <input type="date" maxlength="10" class="field form-control @error('instrument_date_at') border border-danger @enderror" name="instrument_date_at"
                                               id="instrumentDataAt" value="{{ old('instrument_date_at', $building->instrument_date_at) }}" required>
                                    ...
                                    <div class="col-md-4 mb-1">
                                        ...
                                        <input type="text" class="field form-control @error('court') border border-danger @enderror" name="court"
                                               id="courtName" value="{{ old('court', $building->court) }}" placeholder="{{ __('shared::estates.court') }}" required>
                                        @error('court')
                                        <div>
                                            <span class="badge badge-danger">{{ $message }}</span>
                                        </div>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-3 mb-1">
                                        ...
                                        <input type="text" class="field form-control @error('construction_license_number') border border-danger @enderror"
                                               ...
                                               id="constructionLicenseNumber" value="{{ old('construction_license_number', $building->construction_license_number) }}"
                                               placeholder="{{ __('shared::estates.construction_license_number') }}" maxlength="10" required>
                                    ...
                                    <div class="col-md-3 mb-1">
                                        ...
                                        <input type="date" class="field form-control @error('construction_license_date_at') border border-danger @enderror"
                                               ...
                                               id="constructionLicenseDateAt" value="{{ old('construction_license_date_at', $building->construction_license_date_at) }}"
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="checkbox" id="buildingTypeResidential"
                                                   name="usage_type[]" value="residential" {{ old('usage_type.0') == 'residential' || in_array('residential', $building->usage_type) ? 'checked' : '' }}>
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="checkbox" id="buildingTypeCommerical"
                                                   name="usage_type[]" value="commercial" {{ old('usage_type.1', $building->usage_type) == 'commercial' || in_array('commercial', $building->usage_type) ? 'checked' : '' }}>
                                ...
                                <div class="form-row">
                                    <div class="col-md-12">
                                        ...
                                        &nbsp;&nbsp;<span>
                                            <a href="{{url('/images')}}/{{ @$building->instrument_image }}">
                                                {{ __('shared::commons.current_image') }}
                                            </a>
                                        </span>
                                ...
                                <div class="form-row">
                                    <div class="col-md-12">
                                        ...
                                        &nbsp;&nbsp;<span>
                                            <a href="{{url('/images')}}/{{ @$building->license_image }}">
                                                {{ __('shared::commons.current_image') }}
                                            </a>
                                        </span>
                                ...
                                <div class="form-row">
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <textarea name="extra_details"
                                                  ...
                                                  rows="8"
                                                  id="extraDetails">{{ old('extra_details', $building->extra_details) }}</textarea>
                                        @error('extra_details')
                                        <div>
                                            <span class="badge badge-danger">{{ $message }}</span>
                                        </div>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-2 mb-2">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio"
                                                   ...
                                                   value="monthly" @if(old('rent_type') == 'monthly' || $building->rent_type == 'monthly') checked @endif>
                                    ...
                                    <div class="col-md-2 mb-2">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="rent_type"
                                                   ...
                                                   value="quarterly" @if(old('rent_type') == 'quarterly' || $building->rent_type == 'quarterly') checked @endif>
                                    ...
                                    <div class="col-md-2 mb-2">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="rent_type"
                                                   id="rentTypeMidterm"
                                                   value="midterm" @if(old('rent_type') == 'midterm' || $building->rent_type == 'midterm') checked @endif>
                                    ...
                                    <div class="col-md-2 mb-2">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio"
                                                   name="rent_type"
                                                   id="rentTypeYearly" value="yearly" @if(old('rent_type') == 'yearly' || $building->rent_type == 'yearly') checked @endif>
                                ...
                                <div class="form-row">
                                    <div class="col-md-12">
                                        <label>{{ __('shared::estates.current_building_images') }}</label>
                                    </div>
                                    <div class="col-md-12 mb-4">
                                        @foreach($building->images()->where(['more' => 'building-image', 'more' => null])->get() as $image)
