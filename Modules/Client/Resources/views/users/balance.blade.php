@extends('client::layouts.master')@section('content')
    <section class="roles-and-permissions">
        <div class="container">            @include('admin::layouts.partials._success')
            <section class="heading">
                <div class="container">
                    <div class="heading__body old-requests"><h1>  {{ __('الميزانيه') }}</h1>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="search-results__action">
                                        ...
                                        <div class="form-group">                                           @if(@$balances == null)
                                                ...
                                                </button>                                    @else                                                @if(@$balances->is_accepted != true)
