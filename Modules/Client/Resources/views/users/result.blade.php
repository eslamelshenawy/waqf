...
<div class="row">
    <div class="col-md-12">
        <div class="card mb-4">
            <div class="card-body">
                <h4 class="card-title mb-3">{{ ' ' . __(' الميزانيه') }}</h4>
                    ...
                    <div id="rrtable">
                        <table id="multicolumn_ordering_table" class="table table-striped table-bordered" style="width:100%">
                            ...
                            <tr>
                                ...
                                {{--                                            <td></td>--}}
                                <td scope="row">{{(($changesumDebit -$changesumCredit)-$total45454) >0 ? (($changesumDebit -$changesumCredit)-$total45454) : ""  }}</td>
                            </tr>
                            <tr>
                                <td><span>مجموع الأصول غير متداولة</span>
                                </td>
                                {{--                                            <td>---</td>--}}
                                <td scope="row">{{$changesumDebit -$changesumCredit }}</td>
                            </tr>
                            @php
                            ...
                            <tr class="openTr pointer" id="parentTr">
                                ...
                                <td scope="row">{{$monyCashBankmovesumDebit -$monyCashBankmovesumCredit   }}</td>
                            </tr>
                            <tr>
                                <td><span>مدينون  وارصدة مدينة اخرى</span>
                                </td>
                                <td scope="row">{{$ReceivablesBalancesmovesumDebit  - $ReceivablesBalancesmovesumCredit   }}</td>
                            </tr>
                            @php
                            ...
                            <tr>
                                ...
                                {{--                                            <td style="    border-style: solid;"></td>--}}
                                <td style="    border-style: solid;">{{$totalCurrentassets   }}</td>
                            </tr>
                            @php
                            ...
                            <tr>
                                ...
                                <td style="    border-style: solid;">{{$totalAllassets}}</td>
                            </tr>
                            <tr class="openTr pointer" id="parentTr">
                                <td>
                            ...
                            <tr>
                                ...
                                <td scope="row">{{$CurrentliabilitiesmovesumCredit - $CurrentliabilitiesmovesumDebit  }}</td>
                            </tr>
                            @php
                            ...
                            <tr>
                                ...
                                <td scope="row">{{$totalCurrentliabilities }}</td>
                            </tr>
                            <tr>
                                <td><span>  حقوق الملكية</span>
                                </td>
                                <td scope="row">{{$AngelrightsmovesumCredit - $AngelrightsmovesumDebit   }}</td>
                            </tr>
                            <tr>
                                <td><span>  راسمال الوقف</span>
                                </td>
                                <td scope="row">{{$EndowmentcapitalSumMoveCredit  - $EndowmentcapitalSumMoveDebit }}</td>
                            </tr>
                            @php
                            ...
                            <tr>
                                ...
                                <td scope="row">{{$ReservesprovisionsSumMoveCredit - $ReservesprovisionsSumMoveDebit}}</td>
                            </tr>
                            @php
                            ...
                            <tr>
                                ...
                                <td scope="row">{{$totalcreditincome - $totalcreditexpenses}}</td>
                            </tr>
                            @php
                            ...
                            <tr>
                                ...
                                {{--                                            <td style="    border-style: solid;">---</td>--}}
                                <td style="    border-style: solid;">{{$total3}}</td>
                            </tr>
                            <tr>
                                <td><span class=" bold" style=" border-style: groove;"> مجموع حقوق الملكية والالتزامات </span>
                                </td>
                                <td style="    border-style: solid;">{{$totalCurrentliabilities + $total3}}</td>
                            </tr>
