    ...
    <div class="container" id="tenantContainer">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card mb-4">
                    <div class="card-body">
                        <div class="card-title"><br><h4>Create new payment voucher</h4><br></div>
                        <hr>
                    ...
                    <form class="needs-validation" novalidate method="POST" action="{{ route('Admin::buildings.store') }}" autocomplete="off" enctype="multipart/form-data">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-3 mb-2">
                                <label for="userId">Beneficiary (Owner)</label>
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-3 mb-2">
                                ...
                                <input type="text" class="field form-control @error('building_number') border border-danger @enderror" name="building_number"
                                       id="buildingNumber" value="{{ old('building_number') }}" placeholder="Building No." required>
                            ...
                            <div class="col-md-3 mb-2">
                                ...
                                <input type="text" class="field form-control @error('building_space') border border-danger @enderror" name="building_space"
                                       id="buildingSpace" value="{{ old('building_space') }}" placeholder="Building Space" required>
                       ...
                       <hr>
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-4 mb-1">
                                ...
                                <input type="text" class="field form-control @error('court') border border-danger @enderror" name="court"
                                       id="courtName" value="{{ old('court') }}" placeholder="Court name" required>
                                @error('court')
                                <div>
                                    <span class="badge badge-danger">{{ $message }}</span>
                                </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-3 mb-1">
                                <label for="constructionLicenseNumber">Construction License Number</label>
                            ...
                            <!-- Start Building Number -->
                            <div class="col-md-3 mb-1">
                                <label for="constructionLicenseDateAt">Construction License Date</label>
                        ...
                        <div class="form-row">
                            <div class="col-md-12 mb-4">
                                <label class="form-check-label">Building Type</label>
                            </div>
                        ...
                        <div class="form-row">
                            <div class="col-md-12 mb-4 mt-2">
                                <label class="form-check-label">Rent Type</label>
                            </div>
                        ...
                        <button type="submit" class="btn btn-raised btn-raised-primary btn-rounded m-1 mt-3">Create</button>
                    </form>
