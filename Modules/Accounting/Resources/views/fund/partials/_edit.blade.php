        ...
        <div class="row justify-content-between">
            <div class="col-md-10">
                ...
                <div class="col-sm-4 form-group mb-3 pl-0">
                    ...
                    <input type="text" class="form-control @error('order_number') border border-danger @enderror" id="invoiceNumber"
                ...
                <div class="col-sm-4 form-group mb-3 pl-0">
                    ...
                    <input type="text" class="form-control @error('invoice_code') border border-danger @enderror" id="invoiceCode"
                ...
                <div class="col-sm-12 col-md-12 form-group mb-3 pl-0">
                    ...
                    <textarea class="form-control @error('notes') border border-danger @enderror" id="notes"
