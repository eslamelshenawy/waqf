                ...
                <div class="card mb-4">
                    <div class="card-body">
                        ...
                        <form class="needs-validation" novalidate method="get"
                              action="{{ url('accounting/fund/update', $fund_bank->id) }}" enctype="multipart/form-data">
                            @csrf
                            @method('get')
                            ...
                            <div class="form-row">
                                <div class="col-md-4 mb-4">
                                    ...
                                    <select class="form-control" name="typefund" id="typefund" required>
                                        ...
                                        @foreach($account->where('parent_id', '!=' ,null )->get() as $c)
                                            <option value="{{ $c->parent_id }}" {{  $fund_bank->account_id ? $fund_bank->account_id : old('typefund') == $c->parent_id ? 'selected' : '' }} >{{ $c->name  }}
                                                </option>
                                        @endforeach
                                    </select>
                                    @error('typefund')
                                ...
                                <div class="col-md-4 mb-4">
                                    ...
                                    <input type="text"
                                           ...
                                           name="name_fund"  value="{{ $fund_bank->name ? $fund_bank->name : old('name_fund') }}" id="name_fund"
                            ...
                            <div class="form-row">
                                <div class="col-md-4 mb-4">
                                    ...
                                    <input type="number"
                                           ...
                                           name="balance" value="{{ $fund_bank->balance ? $fund_bank->balance : old('balance') }}" id="balance"
                                    ...
                                    <div class="col-md-4 mb-4">
                                        ...
                                        <input type="text"
                                               ...
                                               name="number_account" value="{{ $fund_bank->number_account ? $fund_bank->number_account : old('number_account') }}" id="number_account"
