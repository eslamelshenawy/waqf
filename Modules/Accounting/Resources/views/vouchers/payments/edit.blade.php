                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <form class="needs-validation" novalidate method="post"
                                  action="{{ route('Accounting::vouchers.payments.update', $voucher->id)}}" autocomplete="off"
                                    ...
                                    <div class="col-md-12" id="voucher">
                                        <div class="col-md-10 offset-md-2 form-group mb-3 pr-0">
                                            <select class="form-control @error('voucher_type') border border-danger @enderror"
                                                ...
                                                <option value="سند داخلى" {{$voucher->voucherable_type == "سند داخلى"  ? "selected" : ""}}>سند صرف داخلى</option>
                                                <option value="سند خارجى" {{$voucher->voucherable_type == "سند خارجى"  ? "selected" : ""}}>سند صرف خارجى</option>
                                            </select>
                                        </div>
                                        @error('voucher_type')
                                        <div>
                                ...
                                <div style="display: none;" id="voucher_in">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <select class=" form-control select2 @error('account_idAttributable_in') border border-danger @enderror" style=" width: 50%;"
                                            ...
                                            @foreach(\Modules\Accounting\Entities\Account::with(['account', 'childes'])->get()->sortBy('code') as  $account)
                                                <option value="{{$account->id}}" {{$voucher->account_idAttributable == $account->id  ? "selected" : ""}}>{{$account->name}} && {{$account->id}}</option>
                                            @endforeach
                                    ...
                                    <div class="col-md-6 mb-2" id="checke_num" style="display: none;">
                                        ...
                                        <input type="text" name="checke_num_in" class="form-control @error('checke_num_in') border border-danger @enderror"  value="{{$voucher->check_num}}" id="checke_num"/>
                                        @error('checke_num_in')
                                        <div>
                                            <span class="badge badge-danger">{{ $message }}</span>
                                        </div>
                                    ...
                                    <div class="col-sm-4 form-group mb-3 pl-0" style="display: none;" id="date_Due">
                                        <div class="form-group mb-3">
                                            ...
                                            <input id="order-datepicker2"
                                                   class="form-control text-right @error('date_Due_in') @enderror"
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="2">
                                                            ...
                                                            <input type="text"  name="amount_in"
                                                                   ...
                                                                   value="{{$voucher->account->debit  ? $voucher->account->debit - ($voucher->account->credit >0 ? $voucher->account->credit : (-1* $voucher->account->credit)) : 0}}" readonly></td>
                            ...
                            @enderror
                                                    ...
                                                    <td>
                                                        @if($voucher->paymentable_type == "Bank" )
                                                            <input type="text"
                                                                   ...
                                                                   class="form-control small-input mb-1 @error('remaining_amount_in') border border-danger @enderror"
                                        ...
                                        <div class="col-sm-4 form-group mb-3 pl-0">
                                            <div class="form-group mb-3">
                                                ...
                                                <input id="order-datepicker1"
                                                       class="form-control text-right @error('date_voucher_out') border border-danger @enderror"
                                ...
                                @inject('VocherOutUsers',"\App\VocherOutUsers")
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <select class="Name_user_out form-control select2  @error('user_id_out') border border-danger @enderror" style=" width: 50%;"
                                                name="user_id_out">
                                            @foreach(\App\Agency::all()  as $VocherOutUser)
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <select class=" form-control @error('account_idAttributable_out') border border-danger @enderror " style=" width: 50%;"
                                    ...
                                    <div class="col-md-6 mb-2" id="checke_num_out" style="display: none;">
                                        ...
                                        <input type="text" name="checke_num_out" class="form-control @error('checke_num_out') border border-danger @enderror" id="checke_num_out"  value="{{$voucher->check_num}}"/>
