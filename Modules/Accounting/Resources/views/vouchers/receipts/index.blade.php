                ...
                <div class="card mb-4">
                    ...
                    <div class="table-responsive">
                                    ...
                                    <tr>
                                                ...
                                                <td>
                                                    @if(auth()->user()->hasRole('super-admin') ||auth()->user()->can('update vouchers'))
                                                        <a href="{{ route('Accounting::vouchers.receipts.edit', $voucher->id)}}" class="text-success mr-2">
                        ...
                        @if(auth()->user()->hasRole('super-admin') ||auth()->user()->can('create vouchers'))
                            <a class="btn btn-raised btn-raised-primary btn-rounded m-1" href="{{ route('Accounting::vouchers.receipts.create') }}">&plus; add</a>
                        @endif
                    </div>
