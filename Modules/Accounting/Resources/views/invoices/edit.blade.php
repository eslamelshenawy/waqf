...
{{--                                        </div>--}}
                                        ...
                                        <div class="col-sm-4 form-group mb-3 pl-0">
                                            ...
                                            <input disabled type="text" name="order_number"  value="{{$invoice->order_number}}" class="form-control @error('order_number') border border-danger @enderror" id="invoiceNumber"
                                        ...
                                        <div class="col-sm-4 form-group mb-3 pl-0">
                                            ...
                                            <input type="text" name="invoice_code"  value="{{$invoice->invoice_code}}" maxlength="8" class="form-control @error('invoice_code') border border-danger @enderror" id="invoiceCode"
...
{{--                                    </div>--}}
                                    ...
                                    <div class="col-md-6" id="paymentModeDiv" style="display:none;">
                                        ...
                                        <div class="pr-0 mb-4">
                                            ...
                                            <label class="radio radio-reverse radio-warning">
                                                <input type="radio" class="form-control @error('payment_mode') @enderror" name="payment_mode" value="bank" {{$invoice->payment_mode == 'bank' ? 'checked' : '' }} id="paymentModeBank" onchange="determinePaymentMode(this.value)">
                                            ...
                                            <div class="col-md-10 form-group mb-3 pl-0">
                                                <select class="form-control @error('fund_id') border border-danger @enderror" name="fund_id">
                                                    ...
                                                    @foreach(\Modules\Accounting\Entities\Account::whereIn('id',[21,22])->get() as $fund)
                                                        <option value="{{ $fund->id }}" {{$invoice->account_id == $fund->id ? 'selected' : '' }}>{{ $fund->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            @error('fund_id')
                                            ...
                                            <div class="col-md-10 form-group mb-3 pl-0">
                                                <select class="form-control @error('bank_id') border border-danger @enderror" name="bank_id">
                                                    ...
                                                    @foreach(\Modules\Accounting\Entities\Account::whereIn('id',[25,26])->get() as $bank)
                                                        <option value="{{ $bank->id }}" {{$invoice->account_id == $bank->id ? 'selected' : '' }}>{{ $bank->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            @error('bank_id')
                                ...
                                <div class="col-md-4 mb-4">
                                    @inject('account', '\Modules\Accounting\Entities\Account')
                                    <label for="type">{{ __('accounting::_.typefund') }}</label>
                                    <select class="form-control @error('service_name') border border-danger @enderror" name="account_id" id="account_id" required>
                                        <option selected disabled>{{ __('shared::actions.select') }}</option>
                                        @foreach($account->get() as $c)
                                            <option value="{{ $c->id }}" {{ $invoice->account_id == $c->id ? 'selected' : '' }} >{{ $c->name  }}
                                            </option>
                                        @endforeach
                                    </select>
                                    @error('account_id')
...
{{--                                                <th scope="col">{{ __('accounting::_.service_', ['something' => 'وصف']) }}</th>--}}
                                            ...
                                            <tr>
                                                <th scope="row">1</th>
                                                <td>
                                                    <input name="service_name" type="text" value="{{$invoiceDetails->service_name}}" class="form-control @error('service_name') border border-danger @enderror"
                                                ...
                                                <td>
                                                    <input name="service_price" maxlength="5" type="text" class="form-control @error('service_price') border border-danger @enderror" value="{{$invoiceDetails->service_price}}"
