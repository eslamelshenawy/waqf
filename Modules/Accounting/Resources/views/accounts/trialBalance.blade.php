                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table id="multicolumn_ordering_tabl" class="table table-striped table-bordered" style="width:100%">
                                    ...
                                    @inject('Accounts', '\Modules\Accounting\Entities\Account')
                                    @inject('Journal', '\Modules\Accounting\Entities\Journal')
                                    @php
                                        $sumdebit=0;
                                        $sumcredit=0;
                                        $sumAssetsDebit=0;
                                    ...
                                    <tr>
                                        ...
                                        <td scope="row">{{$sumassetsDebit1}}</td>
                                        <td scope="row">{{$sumassetsCedit1}}</td>
                                        <td scope="row">{{$assetsmovesumDebit}}</td>
                                        <td scope="row">{{$assetsmovesumCredit}}</td>
                                        <td scope="row">{{($assetsmovesumDebit -$assetsmovesumCredit) > 0 ? ($assetsmovesumDebit -$assetsmovesumCredit) : ""  }}</td>
                                        <td scope="row">{{($assetsmovesumDebit -$assetsmovesumCredit) <0 ? ($assetsmovesumDebit -$assetsmovesumCredit) : ""  }}</td>
                                    </tr>
                                    @php
                                    ...
                                    <tr>
                                        ...
                                        <td scope="row">{{$sumfixedAssetsDebit1}}</td>
                                        <td scope="row">{{$sumfixedAssetsCedit1}}</td>
                                        <td scope="row">{{$fixedAssetsmovesumDebit}}</td>
                                        <td scope="row">{{$fixedAssetsmovesumCredit}}</td>
                                        <td scope="row">{{($fixedAssetsmovesumDebit -$fixedAssetsmovesumCredit) >0 ? $fixedAssetsmovesumDebit -$fixedAssetsmovesumCredit : ""  }}</td>
                                        <td scope="row">{{($fixedAssetsmovesumDebit -$fixedAssetsmovesumCredit) <0 ? $fixedAssetsmovesumDebit -$fixedAssetsmovesumCredit : ""  }}</td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td scope="row">{{$land->debitFrist}}</td>
                                        <td scope="row">{{$land->creditFrist}}</td>
                                        <td scope="row">{{$landSumMoveDebit}}</td>
                                        <td scope="row">{{$landSumMoveCredit}}</td>
                                        <td scope="row">{{($landSumMoveDebit -$landSumMoveCredit) >0 ? $landSumMoveDebit -$landSumMoveCredit : ""  }}</td>
                                        <td scope="row">{{($landSumMoveDebit -$landSumMoveCredit) <0 ? $landSumMoveDebit -$landSumMoveCredit : ""  }}</td>
                                    </tr>
                                    <tr>
                                        <td scope="row"></td>
                                        ...
                                        <td scope="row">{{$building->debitFrist}}</td>
                                        <td scope="row">{{$building->creditFrist}}</td>
                                        <td scope="row">{{$buildingSumMoveDebit}}</td>
                                        <td scope="row">{{$buildingSumMoveCredit}}</td>
                                        <td scope="row">{{($buildingSumMoveDebit -$buildingSumMoveCredit) >0 ? $buildingSumMoveDebit -$buildingSumMoveCredit : ""  }}</td>
                                        <td scope="row">{{($buildingSumMoveDebit -$buildingSumMoveCredit) <0 ? $buildingSumMoveDebit -$buildingSumMoveCredit : ""  }}</td>
                                    </tr>
                                    <tr>
                                        <td scope="row"></td>
                                        ...
                                        <td scope="row">{{$sumbankDebit1 + $sumcashDebit1}}</td>
                                        <td scope="row">{{$sumbankCedit1 + $sumcashCedit1}}</td>
                                        <td scope="row">{{$bankmovesumDebit + $cashmovesumDebit}}</td>
                                        <td scope="row">{{$cashmovesumCredit + $bankmovesumCredit}}</td>
                                        <td scope="row">{{(($bankmovesumDebit + $cashmovesumDebit) -($cashmovesumCredit + $bankmovesumCredit)) > 0 ? (($bankmovesumDebit + $cashmovesumDebit) -($cashmovesumCredit + $bankmovesumCredit)) : 0 }}</td>
                                        <td scope="row">{{(($bankmovesumDebit + $cashmovesumDebit) -($cashmovesumCredit + $bankmovesumCredit)) < 0 ? (($bankmovesumDebit + $cashmovesumDebit) -($cashmovesumCredit + $bankmovesumCredit)) : 0  }}</td>
                                    </tr>
                                    <tr>
                                        <td scope="row"></td>
                                        ...
                                        <td scope="row">{{$summonyCashBankDebit1}}</td>
                                        <td scope="row">{{$summonyCashBankCedit1}}</td>
                                        <td scope="row">{{$monyCashBankmovesumDebit}}</td>
                                        <td scope="row">{{$monyCashBankmovesumCredit}}</td>
                                        <td scope="row">{{($monyCashBankmovesumDebit -$monyCashBankmovesumCredit) >0 ? $monyCashBankmovesumDebit -$monyCashBankmovesumCredit : ""  }}</td>
                                        <td scope="row">{{($monyCashBankmovesumDebit -$monyCashBankmovesumCredit) <0 ? $monyCashBankmovesumDebit -$monyCashBankmovesumCredit : ""  }}</td>
                                    </tr>
                                    <tr>
                                        <td scope="row"></td>
                                        ...
                                        <td scope="row">{{$sumcashDebit1}}</td>
                                        <td scope="row">{{$sumcashCedit1}}</td>
                                        <td scope="row">{{$cashmovesumDebit}}</td>
                                        <td scope="row">{{$cashmovesumCredit}}</td>
                                        <td scope="row">{{($cashmovesumDebit -$cashmovesumCredit) >0 ? $cashmovesumDebit -$cashmovesumCredit : ""  }}</td>
                                        <td scope="row">{{($cashmovesumDebit -$cashmovesumCredit) <0 ? $cashmovesumDebit -$cashmovesumCredit : ""  }}</td>
                                    </tr>
                                    <tr>
                                        <td scope="row"></td>
                                        ...
                                        <td scope="row">{{$box1->debitFrist}}</td>
                                        <td scope="row">{{$box1->creditFrist}}</td>
                                        <td scope="row">{{$box1SumMoveDebit}}</td>
                                        <td scope="row">{{$box1SumMoveCredit}}</td>
                                        <td scope="row">{{($box1SumMoveDebit -$box1SumMoveCredit) >0 ? $box1SumMoveDebit -$box1SumMoveCredit : ""  }}</td>
                                        <td scope="row">{{($box1SumMoveDebit -$box1SumMoveCredit) <0 ? $box1SumMoveDebit -$box1SumMoveCredit : ""  }}</td>
                                    </tr>
                                    <tr>
                                        <td scope="row"></td>
                                        ...
                                        <td scope="row">{{$box2->debitFrist}}</td>
                                        <td scope="row">{{$box2->creditFrist}}</td>
                                        <td scope="row">{{$box2SumMoveDebit}}</td>
                                        <td scope="row">{{$box2SumMoveCredit}}</td>
                                        <td scope="row">{{($box2SumMoveDebit -$box2SumMoveCredit) >0 ? $box2SumMoveDebit -$box2SumMoveCredit : ""  }}</td>
                                        <td scope="row">{{($box2SumMoveDebit -$box2SumMoveCredit) <0 ? $box2SumMoveDebit -$box2SumMoveCredit : ""  }}</td>
                                    </tr>
                                    <tr>
                                        <td scope="row"></td>
                                        ...
                                        <td scope="row">{{$boxcheck->debitFrist}}</td>
                                        <td scope="row">{{$boxcheck->creditFrist}}</td>
                                        <td scope="row">{{$boxcheckSumMoveDebit}}</td>
                                        <td scope="row">{{$boxcheckSumMoveCredit}}</td>
                                        <td scope="row">{{($boxcheckSumMoveDebit -$boxcheckSumMoveCredit) >0 ? $boxcheckSumMoveDebit -$boxcheckSumMoveCredit : ""  }}</td>
                                        <td scope="row">{{($boxcheckSumMoveDebit -$boxcheckSumMoveCredit) <0 ? $boxcheckSumMoveDebit -$boxcheckSumMoveCredit : ""  }}</td>
                                    </tr>
                                    <tr>
                                        <td scope="row"></td>
                                        ...
                                        <td scope="row">{{$sumbankDebit1}}</td>
                                        <td scope="row">{{$sumbankCedit1}}</td>
                                        <td scope="row">{{$bankmovesumDebit}}</td>
                                        <td scope="row">{{$bankmovesumCredit}}</td>
                                        <td scope="row">{{($bankmovesumDebit -$bankmovesumCredit) >0 ? $bankmovesumDebit -$bankmovesumCredit : ""  }}</td>
                                        <td scope="row">{{($bankmovesumDebit -$bankmovesumCredit) <0 ? $bankmovesumDebit -$bankmovesumCredit : ""  }}</td>
                                    </tr>
                                    @php
                                    ...
                                    <tr>
                                        ...
                                        <td scope="row">{{$bank1->debitFrist}}</td>
                                        <td scope="row">{{$bank1->creditFrist}}</td>
                                        <td scope="row">{{$bank1SumMoveDebit}}</td>
                                        <td scope="row">{{$bank1SumMoveCredit}}</td>
                                        <td scope="row">{{($bank1SumMoveDebit -$bank1SumMoveCredit) >0 ? $bank1SumMoveDebit -$bank1SumMoveCredit : ""  }}</td>
                                        <td scope="row">{{($bank1SumMoveDebit -$bank1SumMoveCredit) <0 ? $bank1SumMoveDebit -$bank1SumMoveCredit : ""  }}</td>
                                    </tr>
                                    @php
                                    ...
                                    <tr>
                                        ...
                                        <td scope="row">{{$bank2->debitFrist}}</td>
                                        <td scope="row">{{$bank2->creditFrist}}</td>
                                        <td scope="row">{{$bank2SumMoveDebit}}</td>
                                        <td scope="row">{{$bank2SumMoveCredit}}</td>
                                        <td scope="row">{{($bank2SumMoveDebit -$bank2SumMoveCredit) >0 ? $bank2SumMoveDebit -$bank2SumMoveCredit : ""  }}</td>
                                        <td scope="row">{{($bank2SumMoveDebit -$bank2SumMoveCredit) <0 ? $bank2SumMoveDebit -$bank2SumMoveCredit : ""  }}</td>
                                    </tr>
                                    @php
                                    ...
                                    <tr>
                                        ...
                                        <td scope="row">{{$sumDebtorsDebit1}}</td>
                                        <td scope="row">{{$sumDebtorsCedit1}}</td>
                                        <td scope="row">{{$DebtorsmovesumDebit}}</td>
                                        <td scope="row">{{ $DebtorsmovesumCredit}}</td>
                                        <td scope="row">{{($DebtorsmovesumDebit -$DebtorsmovesumCredit) > 0 ?  $DebtorsmovesumDebit -$DebtorsmovesumCredit : 0  }}</td>
                                        <td scope="row">{{($DebtorsmovesumDebit -$DebtorsmovesumCredit) < 0 ?  $DebtorsmovesumDebit -$DebtorsmovesumCredit : 0  }}</td>
                                    </tr>
                                    <tr>
                                        <td scope="row"></td>
                                        ...
                                        <td scope="row">{{$customers->debitFrist}}</td>
                                        <td scope="row">{{$customers->creditFrist}}</td>
                                        <td scope="row">{{$customersSumMoveDebit}}</td>
                                        <td scope="row">{{ $customersSumMoveCredit}}</td>
                                        <td scope="row">{{($customersSumMoveDebit -$customersSumMoveCredit) > 0 ?  $customersSumMoveDebit -$customersSumMoveCredit : 0  }}</td>
                                        <td scope="row">{{($customersSumMoveDebit -$customersSumMoveCredit) < 0 ?  $customersSumMoveDebit -$customersSumMoveCredit : 0  }}</td>
                                    </tr>
                                    <tr>
                                        <td scope="row"></td>
                                        ...
                                        <td scope="row">{{$promise->debitFrist}}</td>
                                        <td scope="row">{{$promise->creditFrist}}</td>
                                        <td scope="row">{{$promiseSumMoveDebit}}</td>
                                        <td scope="row">{{$promiseSumMoveCredit}}</td>
                                        <td scope="row">{{($promiseSumMoveDebit -$promiseSumMoveCredit) >0 ? $promiseSumMoveDebit -$promiseSumMoveCredit : ""  }}</td>
                                        <td scope="row">{{($promiseSumMoveDebit -$promiseSumMoveCredit) <0 ? $promiseSumMoveDebit -$promiseSumMoveCredit : ""  }}</td>
                                    </tr>
                                    <tr>
                                        <td scope="row"></td>
                                        ...
                                        <td scope="row">{{$promiseSumMoveDebit}}</td>
                                        <td scope="row">{{$promiseSumMoveCredit}}</td>
                                        <td scope="row">{{($promise->debit -$promise->credit) >0 ? $promise->debit -$promise->credit : ""  }}</td>
                                        <td scope="row">{{($promise->debit -$promise->credit) <0 ? $promise->debit -$promise->credit : ""  }}</td>
                                    </tr>
                                    <tr>
                                        <td scope="row"></td>
                                        ...
                                        <td scope="row">{{$advance->debitFrist}}</td>
                                        <td scope="row">{{$advance->creditFrist}}</td>
                                        <td scope="row">{{$advanceSumMoveDebit}}</td>
                                        <td scope="row">{{$advanceSumMoveCredit}}</td>
                                        <td scope="row">{{($advanceSumMoveDebit -$advanceSumMoveCredit) >0 ? $advanceSumMoveDebit -$advanceSumMoveCredit : ""  }}</td>
                                        <td scope="row">{{($advanceSumMoveDebit -$advanceSumMoveCredit) <0 ? $advanceSumMoveDebit -$advanceSumMoveCredit : ""  }}</td>
                                    </tr>
                                    @php
                                    ...
                                    <tr>
                                        ...
                                        <td scope="row">{{$BeneficiaryAdvanceexpenses->debitFrist}}</td>
                                        <td scope="row">{{$BeneficiaryAdvanceexpenses->creditFrist}}</td>
                                        <td scope="row">{{$BeneficiaryAdvanceexpensesSumMoveDebit}}</td>
                                        <td scope="row">{{$BeneficiaryAdvanceexpensesSumMoveCredit}}</td>
                                        <td scope="row">{{$BeneficiaryAdvanceexpensesSumMoveDebit - $BeneficiaryAdvanceexpensesSumMoveCredit > 0 ? $BeneficiaryAdvanceexpensesSumMoveDebit - $BeneficiaryAdvanceexpensesSumMoveCredit : ""   }}</td>
                                        <td scope="row">{{$BeneficiaryAdvanceexpensesSumMoveDebit - $BeneficiaryAdvanceexpensesSumMoveCredit < 0 ? $BeneficiaryAdvanceexpensesSumMoveDebit - $BeneficiaryAdvanceexpensesSumMoveCredit : ""   }}</td>
                                    </tr>
                                    <tr>
                                        <td scope="row"></td>
                                    ...
                                    <tr>
                                        ...
                                        <td scope="row">{{$Insurances->debitFrist}}</td>
                                        <td scope="row">{{$Insurances->creditFrist}}</td>
                                        <td scope="row">{{$InsurancesSumMoveDebit}}</td>
                                        <td scope="row">{{$InsurancesSumMoveCredit}}</td>
                                        <td scope="row">{{($InsurancesSumMoveDebit -$InsurancesSumMoveCredit) >0 ? $InsurancesSumMoveDebit -$InsurancesSumMoveCredit : ""  }}</td>
                                        <td scope="row">{{($InsurancesSumMoveDebit -$InsurancesSumMoveCredit) <0 ? $InsurancesSumMoveDebit -$InsurancesSumMoveCredit : ""  }}</td>
                                    </tr>
                                    <tr>
                                        <td scope="row"></td>
                                    ...
                                    <tr>
                                        ...
                                        <td scope="row">{{$sumOtherbalancesDebit1}}</td>
                                        <td scope="row">{{$sumOtherbalancesCedit1}}</td>
                                        <td scope="row">{{$OtherbalancesmovesumDebit}}</td>
                                        <td scope="row">{{$OtherbalancesmovesumCredit}}</td>
                                        <td scope="row">{{($OtherbalancesmovesumDebit -$OtherbalancesmovesumCredit) >0 ? $OtherbalancesmovesumDebit -$OtherbalancesmovesumCredit : ""  }}</td>
                                        <td scope="row">{{($OtherbalancesmovesumDebit -$OtherbalancesmovesumCredit) <0 ? $OtherbalancesmovesumDebit -$OtherbalancesmovesumCredit : ""  }}</td>
                                    </tr>
                                    <tr>
                                        <td scope="row"></td>
                                        ...
                                        <td scope="row">{{$Checks->debitFrist}}</td>
                                        <td scope="row">{{$Checks->creditFrist}}</td>
                                        <td scope="row">{{$ChecksSumMoveDebit}}</td>
                                        <td scope="row">{{$ChecksSumMoveCredit}}</td>
                                        <td scope="row">{{($ChecksSumMoveDebit -$ChecksSumMoveCredit) >0 ? $ChecksSumMoveDebit -$ChecksSumMoveCredit : ""  }}</td>
                                        <td scope="row">{{($ChecksSumMoveDebit -$ChecksSumMoveCredit) <0 ? $ChecksSumMoveDebit -$ChecksSumMoveCredit : ""  }}</td>
                                    </tr>
                                    <tr>
                                        <td scope="row"></td>
                                        ...
                                        <td scope="row">{{$Accrued->debitFrist}}</td>
                                        <td scope="row">{{$Accrued->creditFrist}}</td>
                                        <td scope="row">{{$AccruedSumMoveDebit}}</td>
                                        <td scope="row">{{$AccruedSumMoveCredit}}</td>
                                        <td scope="row">{{($AccruedSumMoveDebit -$AccruedSumMoveCredit) >0 ? $AccruedSumMoveDebit -$AccruedSumMoveCredit : ""  }}</td>
                                        <td scope="row">{{($AccruedSumMoveDebit -$AccruedSumMoveCredit) <0 ? $AccruedSumMoveDebit -$AccruedSumMoveCredit : ""  }}</td>
                                    </tr>
                                    <tr>
                                        <td scope="row"></td>
                                    ...
                                    <tr>
                                        ...
                                        <td scope="row">{{$Advancedexpenses->debitFrist}}</td>
                                        <td scope="row">{{$Advancedexpenses->creditFrist}}</td>
                                        <td scope="row">{{$AdvancedexpensesSumMoveDebit}}</td>
                                        <td scope="row">{{$AdvancedexpensesSumMoveCredit}}</td>
                                        <td scope="row">{{($AdvancedexpensesSumMoveDebit -$AdvancedexpensesSumMoveCredit) >0 ? $AdvancedexpensesSumMoveDebit -$AdvancedexpensesSumMoveCredit : ""  }}</td>
                                        <td scope="row">{{($AdvancedexpensesSumMoveDebit -$AdvancedexpensesSumMoveCredit) <0 ? $AdvancedexpensesSumMoveDebit -$AdvancedexpensesSumMoveCredit : ""  }}</td>
                                    </tr>
                                    <tr>
                                        <td scope="row"></td>
                                    ...
                                    <tr>
                                        ...
                                        <td scope="row">{{$sumOpponentsDebit1}}</td>
                                        <td scope="row">{{$sumOpponentsCedit1}}</td>
                                        <td scope="row">{{$OpponentsmovesumDebit}}</td>
                                        <td scope="row">{{$OpponentsmovesumCredit}}</td>
                                        <td scope="row">{{($OpponentsmovesumCredit  - $OpponentsmovesumDebit) <0 ? $OpponentsmovesumCredit  - $OpponentsmovesumDebit : ""  }}</td>
                                        <td scope="row">{{($OpponentsmovesumCredit  - $OpponentsmovesumDebit) >0 ? $OpponentsmovesumCredit  - $OpponentsmovesumDebit : ""  }}</td>
                                    </tr>
                                    @php
                                    ...
                                    <tr>
                                        ...
                                        <td scope="row">{{$sumAngelrightsDebit1}}</td>
                                        <td scope="row">{{$sumAngelrightsCedit1}}</td>
                                        <td scope="row">{{$AngelrightsmovesumDebit}}</td>
                                        <td scope="row">{{$AngelrightsmovesumCredit}}</td>
                                        <td scope="row">{{($sumAngelrightsCedit  - $sumAngelrightsDebit) <0 ? $sumAngelrightsCedit  - $sumAngelrightsDebit : ""  }}</td>
                                        <td scope="row">{{($sumAngelrightsCedit  - $sumAngelrightsDebit) >0 ? $sumAngelrightsCedit  - $sumAngelrightsDebit : ""  }}</td>
                                    </tr>
                                    <tr>
                                        <td scope="row"></td>
                                        ...
                                        <td scope="row">{{$Endowmentcapital->debitFrist}}</td>
                                        <td scope="row">{{$Endowmentcapital->creditFrist}}</td>
                                        <td scope="row">{{$EndowmentcapitalSumMoveDebit}}</td>
                                        <td scope="row">{{$EndowmentcapitalSumMoveCredit}}</td>
                                        <td scope="row">{{($Endowmentcapital->credit  - $Endowmentcapital->debit) <0 ? $Endowmentcapital->credit  - $Endowmentcapital->debit : ""  }}</td>
                                        <td scope="row">{{($Endowmentcapital->credit  - $Endowmentcapital->debit) >0 ? $Endowmentcapital->credit  - $Endowmentcapital->debit : ""  }}</td>
                                    </tr>
                                    <tr>
                                        <td scope="row"></td>
                                        ...
                                        <td scope="row">{{$Reservesprovisions->debitFrist}}</td>
                                        <td scope="row">{{$Reservesprovisions->creditFrist}}</td>
                                        <td scope="row">{{$ReservesprovisionsSumMoveDebit}}</td>
                                        <td scope="row">{{$ReservesprovisionsSumMoveCredit}}</td>
                                        <td scope="row">{{($Reservesprovisions->credit  - $Reservesprovisions->debit) <0 ? $Reservesprovisions->credit  - $Reservesprovisions->debit : ""  }}</td>
                                        <td scope="row">{{($Reservesprovisions->credit  - $Reservesprovisions->debit) >0 ? $Reservesprovisions->credit  - $Reservesprovisions->debit : ""  }}</td>
                                    </tr>
                                    <tr>
                                        <td scope="row"></td>
                                        ...
                                        <td scope="row">{{$sumDistributablesurplusDebit1}}</td>
                                        <td scope="row">{{$sumDistributablesurplusCedit1}}</td>
                                        <td scope="row">{{$DistributablesurplusmovesumDebit}}</td>
                                        <td scope="row">{{$DistributablesurplusmovesumCredit}}</td>
                                        <td scope="row">{{($sumDistributablesurplusCedit  - $sumDistributablesurplusDebit) <0 ? $sumDistributablesurplusCedit  - $sumDistributablesurplusDebit : ""  }}</td>
                                        <td scope="row">{{($sumDistributablesurplusCedit  - $sumDistributablesurplusDebit) >0 ? $sumDistributablesurplusCedit  - $sumDistributablesurplusDebit : ""  }}</td>
                                    </tr>
                                    <tr>
                                        <td scope="row"></td>
                                        ...
                                        <td scope="row">{{$beneficial1->debitFrist}}</td>
                                        <td scope="row">{{$beneficial1->creditFrist}}</td>
                                        <td scope="row">{{$beneficial1SumMoveDebit}}</td>
                                        <td scope="row">{{$beneficial1SumMoveCredit}}</td>
                                        <td scope="row">{{($beneficial1SumMoveCredit  - $beneficial1SumMoveDebit) <0 ? $beneficial1SumMoveCredit  - $beneficial1SumMoveDebit : ""  }}</td>
                                        <td scope="row">{{($beneficial1SumMoveCredit  - $beneficial1SumMoveDebit) >0 ? $beneficial1SumMoveCredit  - $beneficial1SumMoveDebit : ""  }}</td>
                                    </tr>
                                    <tr>
                                        <td scope="row"></td>
                                        ...
                                        <td scope="row">{{$beneficial2->debitFrist}}</td>
                                        <td scope="row">{{$beneficial2->creditFrist}}</td>
                                        <td scope="row">{{$beneficial2SumMoveDebit}}</td>
                                        <td scope="row">{{$beneficial2SumMoveCredit}}</td>
                                        <td scope="row">{{($beneficial2SumMoveCredit  - $beneficial2SumMoveDebit) <0 ? $beneficial2SumMoveCredit  - $beneficial2SumMoveDebit : ""  }} </td>
                                        <td scope="row">{{($beneficial2SumMoveCredit  - $beneficial2SumMoveDebit) >0 ? $beneficial2SumMoveCredit  - $beneficial2SumMoveDebit : ""  }}</td>
                                    </tr>
                                    <tr>
                                        <td scope="row"></td>
                                        ...
                                        <td scope="row">{{$sumCurrentliabilitiesDebit1}}</td>
                                        <td scope="row">{{$sumCurrentliabilitiesCedit1}}</td>
                                        <td scope="row">{{$CurrentliabilitiesmovesumDebit}}</td>
                                        <td scope="row">{{$CurrentliabilitiesmovesumCredit}}</td>
                                        <td scope="row">{{($CurrentliabilitiesmovesumDebit  - $CurrentliabilitiesmovesumCredit) >0 ? $CurrentliabilitiesmovesumDebit  - $CurrentliabilitiesmovesumCredit : ""  }}</td>
                                        <td scope="row">{{($CurrentliabilitiesmovesumCredit  - $CurrentliabilitiesmovesumDebit) >0 ? $CurrentliabilitiesmovesumCredit  - $CurrentliabilitiesmovesumDebit : ""  }}</td>
                                    </tr>
                                    <tr>
                                        <td scope="row"></td>
                                        <td scope="row">221</td>
                                        <td scope="row"> مصروفات مستحقه</td>
                                        <td scope="row">{{$deservedengagements->debitFrist}}</td>
                                        <td scope="row">{{$deservedengagements->creditFrist}}</td>
                                        <td scope="row">{{$deservedengagementsSumMoveDebit}}</td>
                                        <td scope="row">{{$deservedengagementsSumMoveCredit}}</td>
                                        <td scope="row">{{ $deservedengagementsSumMoveDebit - $deservedengagementsSumMoveCredit  >0 ? $deservedengagementsSumMoveDebit - $deservedengagementsSumMoveCredit : ""   }}</td>
                                        <td scope="row">{{$deservedengagementsSumMoveCredit  - $deservedengagementsSumMoveDebit  }}</td>
                                    </tr>
                                    <tr>
                                        <td scope="row"></td>
                                        <td scope="row">222</td>
                                        <td scope="row"> دائنون متنوعون</td>
                                        <td scope="row">{{$miscellaneouscreditors->debitFrist}}</td>
                                        <td scope="row">{{$miscellaneouscreditors->creditFrist}}</td>
                                        <td scope="row">{{$miscellaneouscreditorsSumMoveDebit}}</td>
                                        <td scope="row">{{$miscellaneouscreditorsSumMoveCredit}}</td>
                                        <td scope="row">{{ $miscellaneouscreditorsSumMoveCredit  - $miscellaneouscreditorsSumMoveDebit  >0 ? $miscellaneouscreditorsSumMoveCredit  - $miscellaneouscreditorsSumMoveDebit : ""   }}</td>
                                        <td scope="row">{{$miscellaneouscreditorsSumMoveCredit  - $miscellaneouscreditorsSumMoveDebit  }}</td>
                                    </tr>
                                    <tr>
                                        <td scope="row"></td>
                                        <td scope="row">23</td>
                                        <td scope="row"> مجمع اهلاك الاصول الثابتة</td>
                                        <td scope="row">{{$sumDepreciationfixedassetsDebit1}}</td>
                                        <td scope="row">{{$sumDepreciationfixedassetsCedit1}}</td>
                                        <td scope="row">{{$DepreciationfixedassetsmovesumDebit}}</td>
                                        <td scope="row">{{$DepreciationfixedassetsmovesumCredit}}</td>
                                        <td scope="row">{{($DepreciationfixedassetsmovesumCredit  - $DepreciationfixedassetsmovesumDebit) <0 ? $DepreciationfixedassetsmovesumCredit  - $DepreciationfixedassetsmovesumDebit : ""  }}</td>
                                        <td scope="row">{{($DepreciationfixedassetsmovesumCredit  - $DepreciationfixedassetsmovesumDebit) >0 ? $DepreciationfixedassetsmovesumCredit  - $DepreciationfixedassetsmovesumDebit : ""  }}</td>
                                    </tr>
                                    <tr>
                                        <td scope="row"></td>
                                        ...
                                        <td scope="row">{{$Buildingcomplex->debitFrist}}</td>
                                        <td scope="row">{{$Buildingcomplex->creditFrist}}</td>
                                        <td scope="row">{{$BuildingcomplexSumMoveDebit}}</td>
                                        <td scope="row">{{$BuildingcomplexSumMoveCredit}}</td>
                                        <td scope="row">{{($BuildingcomplexSumMoveCredit  - $BuildingcomplexSumMoveDebit) <0 ? $BuildingcomplexSumMoveCredit  - $BuildingcomplexSumMoveDebit : ""  }}</td>
                                        <td scope="row">{{($BuildingcomplexSumMoveCredit  - $BuildingcomplexSumMoveDebit) >0 ? $BuildingcomplexSumMoveCredit  - $BuildingcomplexSumMoveDebit : ""  }}</td>
                                    </tr>
                                    <tr>
                                        <td scope="row"></td>
                                        ...
                                        <td scope="row">{{$Assembly->debitFrist}}</td>
                                        <td scope="row">{{$Assembly->creditFrist}}</td>
                                        <td scope="row">{{$AssemblySumMoveDebit}}</td>
                                        <td scope="row">{{$AssemblySumMoveCredit}}</td>
                                        <td scope="row">{{($AssemblySumMoveCredit  - $AssemblySumMoveDebit) <0 ? $AssemblySumMoveCredit  - $AssemblySumMoveDebit : ""  }}</td>
                                        <td scope="row">{{($AssemblySumMoveCredit  - $AssemblySumMoveDebit) >0 ? $AssemblySumMoveCredit  - $AssemblySumMoveDebit : ""  }}</td>
                                    </tr>
                                    <tr>
                                        <td scope="row"></td>
                                        ...
                                        <td scope="row">{{$Hardwarecomplex->debitFrist}}</td>
                                        <td scope="row">{{$Hardwarecomplex->creditFrist}}</td>
                                        <td scope="row">{{$HardwarecomplexSumMoveDebit}}</td>
                                        <td scope="row">{{$HardwarecomplexSumMoveCredit}}</td>
                                        <td scope="row">{{($HardwarecomplexSumMoveCredit  - $HardwarecomplexSumMoveDebit) >0 ? $HardwarecomplexSumMoveCredit  - $HardwarecomplexSumMoveDebit : ""  }}</td>
                                        <td scope="row">{{($HardwarecomplexSumMoveCredit  - $HardwarecomplexSumMoveDebit) <0 ? $HardwarecomplexSumMoveCredit  - $HardwarecomplexSumMoveDebit : ""  }}</td>
                                    </tr>
                                    @php
                                    ...
                                    <tr>
                                        ...
                                        <td scope="row">{{$sumexpensesDebit1}}</td>
                                        <td scope="row">{{$sumexpensesCedit1}}</td>
                                        <td scope="row">{{$expensesmovesumDebit}}</td>
                                        <td scope="row">{{$expensesmovesumCredit}}</td>
                                        <td scope="row">{{($expensesmovesumDebit -$expensesmovesumCredit) >0 ? $expensesmovesumDebit -$expensesmovesumCredit : ""  }}</td>
                                        <td scope="row">{{($expensesmovesumDebit -$expensesmovesumCredit) <0 ? $expensesmovesumDebit -$expensesmovesumCredit : ""  }}</td>
                                    </tr>
                                    @php
                                    ...
                                    <tr>
                                        ...
                                        <td scope="row">{{$sumEndowmentexpensesDebit1}}</td>
                                        <td scope="row">{{$sumEndowmentexpensesCedit1}}</td>
                                        <td scope="row">{{$EndowmentexpensesmovesumDebit}}</td>
                                        <td scope="row">{{$EndowmentexpensesmovesumCredit}}</td>
                                        <td scope="row">{{($sumEndowmentexpensesdebit -$sumEndowmentexpensescredit) >0 ? $sumEndowmentexpensesdebit -$sumEndowmentexpensescredit : ""  }}</td>
                                        <td scope="row">{{($sumEndowmentexpensesdebit -$sumEndowmentexpensescredit) <0 ? $sumEndowmentexpensesdebit -$sumEndowmentexpensescredit : ""  }}</td>
                                    </tr>
                                    @php
                                    ...
                                    <tr>
                                        ...
                                        <td scope="row">{{$sumMaintenanceexpensesDebit1}}</td>
                                        <td scope="row">{{$sumMaintenanceexpensesCedit1}}</td>
                                        <td scope="row">{{$MaintenanceexpensesmovesumDebit}}</td>
                                        <td scope="row">{{$MaintenanceexpensesmovesumCredit}}</td>
                                        <td scope="row">{{($MaintenanceexpensesmovesumDebit -$MaintenanceexpensesmovesumCredit) >0 ? $MaintenanceexpensesmovesumDebit -$MaintenanceexpensesmovesumCredit : ""  }}</td>
                                        <td scope="row">{{($MaintenanceexpensesmovesumDebit -$MaintenanceexpensesmovesumCredit) <0 ? $MaintenanceexpensesmovesumDebit -$MaintenanceexpensesmovesumCredit : ""  }}</td>
                                    ...
                                    <tr>
                                        ...
                                        <td scope="row">{{$maintenance1->debitFrist}}</td>
                                        <td scope="row">{{$maintenance1->creditFrist}}</td>
                                        <td scope="row">{{$maintenance1SumMoveDebit}}</td>
                                        <td scope="row">{{$maintenance1SumMoveCredit}}</td>
                                        <td scope="row">{{($maintenance1SumMoveDebit -$maintenance1SumMoveCredit) >0 ? $maintenance1SumMoveDebit -$maintenance1SumMoveCredit : ""  }}</td>
                                        <td scope="row">{{($maintenance1SumMoveDebit -$maintenance1SumMoveCredit) <0 ? $maintenance1SumMoveDebit -$maintenance1SumMoveCredit : ""  }}</td>
                                    </tr>
                                    <tr>
                                        <td scope="row"></td>
                                        ...
                                        <td scope="row">{{$maintenance2->debitFrist}}</td>
                                        <td scope="row">{{$maintenance2->creditFrist}}</td>
                                        <td scope="row">{{$maintenance2SumMoveDebit}}</td>
                                        <td scope="row">{{$maintenance2SumMoveCredit}}</td>
                                        <td scope="row">{{($maintenance2SumMoveDebit -$maintenance2SumMoveCredit) >0 ? $maintenance2SumMoveDebit -$maintenance2SumMoveCredit : ""  }}</td>
                                        <td scope="row">{{($maintenance2SumMoveDebit -$maintenance2SumMoveCredit) <0 ? $maintenance2SumMoveDebit -$maintenance2SumMoveCredit : ""  }}</td>
                                    </tr>
                                    <tr></tr>
                                    <td scope="row"></td>
                                    ...
                                    <td scope="row">{{$genre->debitFrist}}</td>
                                    <td scope="row">{{$genre->creditFrist}}</td>
                                    <td scope="row">{{$genreSumMoveDebit}}</td>
                                    <td scope="row">{{$genreSumMoveCredit}}</td>
                                    <td scope="row">{{($genreSumMoveDebit -$genreSumMoveCredit) >0 ? $genreSumMoveDebit -$genreSumMoveCredit : ""  }}</td>
                                    <td scope="row">{{($genreSumMoveDebit -$genreSumMoveCredit) <0 ? $genreSumMoveDebit -$genreSumMoveCredit : ""  }}</td>
                                    ...
                                    <tr>
                                        ...
                                        <td scope="row">{{$sumGeneraladmiexpensesDebit1}}</td>
                                        <td scope="row">{{$sumGeneraladmiexpensesCedit1}}</td>
                                        <td scope="row">{{$GeneraladmiexpensesmovesumDebit}}</td>
                                        <td scope="row">{{$GeneraladmiexpensesmovesumCredit}}</td>
                                        <td scope="row">{{($GeneraladmiexpensesmovesumDebit -$GeneraladmiexpensesmovesumCredit) >0 ? $GeneraladmiexpensesmovesumDebit -$GeneraladmiexpensesmovesumCredit : ""  }}</td>
                                        <td scope="row">{{($GeneraladmiexpensesmovesumDebit -$GeneraladmiexpensesmovesumCredit) <0 ? $GeneraladmiexpensesmovesumDebit -$GeneraladmiexpensesmovesumCredit : ""  }}</td>
                                    </tr>
                                    <tr>
                                        <td scope="row"></td>
                                        ...
                                        <td scope="row">{{$sumAssetsdepreciationexpensesDebit1}}</td>
                                        <td scope="row">{{$sumAssetsdepreciationexpensesCedit1}}</td>
                                        <td scope="row">{{$AssetsdepreciationexpensesmovesumDebit}}</td>
                                        <td scope="row">{{$AssetsdepreciationexpensesmovesumCredit}}</td>
                                        <td scope="row">{{($AssetsdepreciationexpensesmovesumDebit -$AssetsdepreciationexpensesmovesumCredit) >0 ? $AssetsdepreciationexpensesmovesumDebit -$AssetsdepreciationexpensesmovesumCredit : ""  }}</td>
                                        <td scope="row">{{($AssetsdepreciationexpensesmovesumDebit -$AssetsdepreciationexpensesmovesumCredit) <0 ? $AssetsdepreciationexpensesmovesumDebit -$AssetsdepreciationexpensesmovesumCredit : ""  }}</td>
                                    </tr>
                                    <tr>
                                        <td scope="row"></td>
                                        ...
                                        <td scope="row">{{$Buildingdepreciationexpenses->debitFrist}}</td>
                                        <td scope="row">{{$Buildingdepreciationexpenses->creditFrist}}</td>
                                        <td scope="row">{{$BuildingdepreciationexpensesSumMoveDebit}}</td>
                                        <td scope="row">{{$BuildingdepreciationexpensesSumMoveCredit}}</td>
                                        <td scope="row">{{($BuildingdepreciationexpensesSumMoveDebit -$BuildingdepreciationexpensesSumMoveCredit) >0 ? $BuildingdepreciationexpensesSumMoveDebit -$BuildingdepreciationexpensesSumMoveCredit : ""  }}</td>
                                        <td scope="row">{{($BuildingdepreciationexpensesSumMoveDebit -$BuildingdepreciationexpensesSumMoveCredit) <0 ? $BuildingdepreciationexpensesSumMoveDebit -$BuildingdepreciationexpensesSumMoveCredit : ""  }}</td>
                                    </tr>
                                    <tr>
                                        <td scope="row"></td>
                                        ...
                                        <td scope="row">{{$machinerydepreciationexpenses->debitFrist}}</td>
                                        <td scope="row">{{$machinerydepreciationexpenses->creditFrist}}</td>
                                        <td scope="row">{{$machinerydepreciationexpensesSumMoveDebit}}</td>
                                        <td scope="row">{{$machinerydepreciationexpensesSumMoveCredit}}</td>
                                        <td scope="row">{{($machinerydepreciationexpensesSumMoveDebit -$machinerydepreciationexpensesSumMoveCredit) >0 ? $machinerydepreciationexpensesSumMoveDebit -$machinerydepreciationexpensesSumMoveCredit : ""  }}</td>
                                        <td scope="row">{{($machinerydepreciationexpensesSumMoveDebit -$machinerydepreciationexpensesSumMoveCredit) <0 ? $machinerydepreciationexpensesSumMoveDebit -$machinerydepreciationexpensesSumMoveCredit : ""  }}</td>
                                    </tr>
                                    <tr>
                                        <td scope="row"></td>
                                        ...
                                        <td scope="row">{{$sumincomeDebit1}}</td>
                                        <td scope="row">{{$sumincomeCedit1}}</td>
                                        <td scope="row">{{$incomemovesumDebit}}</td>
                                        <td scope="row">{{$incomemovesumCredit}}</td>
                                        <td scope="row">{{($incomemovesumCredit  - $incomemovesumDebit) <0 ? $incomemovesumCredit  - $incomemovesumDebit : ""  }}</td>
                                        <td scope="row">{{($incomemovesumCredit  - $incomemovesumDebit) >0 ? $incomemovesumCredit  - $incomemovesumDebit : ""  }}</td>
                                    </tr>
                                    @php
                                    ...
                                    <tr>
                                        ...
                                        <td scope="row">{{$sumEndowmentrevenueDebit1}}</td>
                                        <td scope="row">{{$sumEndowmentrevenueCedit1}}</td>
                                        <td scope="row">{{$EndowmentrevenuemovesumDebit}}</td>
                                        <td scope="row">{{$EndowmentrevenuemovesumCredit}}</td>
                                        <td scope="row">{{($EndowmentrevenuemovesumCredit  - $EndowmentrevenuemovesumDebit) <0 ? $EndowmentrevenuemovesumCredit  - $EndowmentrevenuemovesumDebit : ""  }}</td>
                                        <td scope="row">{{($EndowmentrevenuemovesumCredit  - $EndowmentrevenuemovesumDebit) >0 ? $EndowmentrevenuemovesumCredit  - $EndowmentrevenuemovesumDebit : ""  }}</td>
                                    </tr>
                                    <tr>
                                        <td scope="row"></td>
                                        ...
                                        <td scope="row">{{$Revenueapartments->debitFrist}}</td>
                                        <td scope="row">{{$Revenueapartments->creditFrist}}</td>
                                        <td scope="row">{{$RevenueapartmentsSumMoveDebit}}</td>
                                        <td scope="row">{{$RevenueapartmentsSumMoveCredit}}</td>
                                        <td scope="row">{{($RevenueapartmentsSumMoveCredit  - $RevenueapartmentsSumMoveDebit) <0 ? $RevenueapartmentsSumMoveCredit  - $RevenueapartmentsSumMoveDebit : ""  }}</td>
                                        <td scope="row">{{($RevenueapartmentsSumMoveCredit  - $RevenueapartmentsSumMoveDebit) >0 ? $RevenueapartmentsSumMoveCredit  - $RevenueapartmentsSumMoveDebit : ""  }}</td>
                                    </tr>
                                    <tr>
                                        <td scope="row"></td>
                                        ...
                                        <td scope="row">{{$Revenuestores->debitFrist}}</td>
                                        <td scope="row">{{$Revenuestores->creditFrist}}</td>
                                        <td scope="row">{{$RevenuestoresSumMoveDebit}}</td>
                                        <td scope="row">{{$RevenuestoresSumMoveCredit}}</td>
                                        <td scope="row">{{($RevenuestoresSumMoveCredit  - $RevenuestoresSumMoveDebit) <0 ? $RevenuestoresSumMoveCredit  - $RevenuestoresSumMoveDebit : ""  }}</td>
                                        <td scope="row">{{($RevenuestoresSumMoveCredit  - $RevenuestoresSumMoveDebit) >0 ? $RevenuestoresSumMoveCredit  - $RevenuestoresSumMoveDebit : ""  }}</td>
                                    </tr>
                                    <tr>
                                        <td scope="row"></td>
                                        ...
                                        <td scope="row">{{$Otherincome->debitFrist}}</td>
                                        <td scope="row">{{$Otherincome->creditFrist}}</td>
                                        <td scope="row">{{$OtherincomeSumMoveDebit}}</td>
                                        <td scope="row">{{$OtherincomeSumMoveCredit}}</td>
                                        <td scope="row">{{($OtherincomeSumMoveCredit  - $OtherincomeSumMoveDebit) <0 ? $OtherincomeSumMoveCredit  - $OtherincomeSumMoveDebit : ""  }}</td>
                                        <td scope="row">{{($OtherincomeSumMoveCredit  - $OtherincomeSumMoveDebit) >0 ? $OtherincomeSumMoveCredit  - $OtherincomeSumMoveDebit : ""  }}</td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td scope="row"></td>
                                        <td scope="row"> </td>
                                        <td scope="row">{{$sumAssetsDebitFist}}</td>
                                        <td scope="row">{{$sumOpponentsCedit1}}</td>
                                        <td scope="row">{{$totalmoveassetsdebit + $totalmoveincomedebit + $totalmoveexpensesdebit + $totalmoveOpponentsdebit}}</td>
                                        <td scope="row">{{$totalmoveassetscredit + $totalmoveincomecredit +$totalmoveexpensescredit + $totalmoveOpponentscredit}}</td>
                                        <td scope="row">{{$totallastassets + $totallastexpense}}</td>
                                        <td scope="row">{{ $totallastOpponents + $totallastincome}}</td>
                                    </tr>
                                    </tbody>
                                </table>
                            </div>
