        ...
        <div class="row justify-content-between">
            <div class="col-md-10">
                ...
                <div class="col-md-4 mb-4">
                    ...
                    <select class="form-control" name="account_id" id="account_id" required>
                        ...
                        @foreach($account->where('parent_id', '!=' ,null )->get() as $c)
                            <option value="{{ $c->parent_id }}" {{ old('account_id') == $c->parent_id ? 'selected' : '' }} >{{ $c->name  }}
                                && {{$c->type}}</option>
                        @endforeach
                    </select>
                    @error('account_id')
                ...
                <div class="col-sm-4 form-group mb-3 pl-0">
                    ...
                    <input type="text" name="order_number"  class="form-control @error('order_number') border border-danger @enderror" id="invoiceNumber"
                ...
                <div class="col-sm-4 form-group mb-3 pl-0">
                    ...
                    <input type="text" name="invoice_code" class="form-control @error('invoice_code') border border-danger @enderror" id="invoiceCode"
                ...
                <div class="col-sm-4 form-group mb-3 pl-0">
                    <div class="form-group mb-3">
                        ...
                        <input id="order-datepicker" class="form-control text-right @error('order_at') @enderror" placeholder="yyyy-mm-dd" name="order_at">
                        @error('order_at')
                        <div>
                            <span class="badge badge-danger">{{ $message }}</span>
                        </div>
                ...
                <div class="col-sm-12 col-md-12 form-group mb-3 pl-0">
                    ...
                    <textarea class="form-control @error('notes') border border-danger @enderror" name="notes" id="notes"
                              placeholder="{{ __('accounting::_.notes') }}" rows="4" ></textarea>
                    @error('notes')
                    <div>
                        <span class="badge badge-danger">{{ $message }}</span>
                    </div>
            ...
            <div class="col-md-6">
                ...
                <div class="pr-0 mb-4">
                    <label class="radio radio-reverse radio-danger">
                        <input type="radio" name="document_type" class="form-control" value="cash" id="documentTypeCash" onchange="determineDocumentType(this.value)">
                        <span>{{ __('accounting::_.cash') }}</span>
                        <span class="checkmark"></span>
                    </label>
                    <label class="radio radio-reverse radio-warning">
                        <input type="radio" class="form-control @error('document_type') @enderror" name="document_type"  value="credit" id="documentTypeCredit" onchange="determineDocumentType(this.value)">
            ...
            <div class="col-md-6" id="paymentModeDiv" style="display:none;">
                ...
                <div class="pr-0 mb-4">
                    <label class="radio radio-reverse radio-danger">
                        <input type="radio" class="form-control" name="payment_mode" value="fund" id="paymentModeFund" onchange="determinePaymentMode(this.value)">
                        <span>{{ __('accounting::_.fund') }}</span>
                        <span class="checkmark"></span>
                    </label>
                    <label class="radio radio-reverse radio-warning">
                        <input type="radio" class="form-control @error('payment_mode') @enderror" name="payment_mode" value="bank" id="paymentModeBank" onchange="determinePaymentMode(this.value)">
